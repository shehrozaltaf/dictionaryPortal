            ...
            if (file_exists($file)) {
                ...
                foreach ($data['values'] as $key => $val) {
                    if (isset($val[$r[0]])) {
                        ...
                        $formArray_Detail['instruction_l1'] = (isset($val[$r[19]]) && $val[$r[19]] != '' ? $val[$r[19]] : '');
                        $formArray_Detail['instruction_l2'] = (isset($val[$r[20]]) && $val[$r[20]] != '' ? $val[$r[20]] : '');
                        $formArray_Detail['instruction_l3'] = (isset($val[$r[21]]) && $val[$r[21]] != '' ? $val[$r[21]] : '');
                        $formArray_Detail['instruction_l4'] = (isset($val[$r[22]]) && $val[$r[22]] != '' ? $val[$r[22]] : '');
                        $formArray_Detail['instruction_l5'] = (isset($val[$r[23]]) && $val[$r[23]] != '' ? $val[$r[23]] : '');
