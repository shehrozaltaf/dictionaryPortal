...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true"
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item   myproject"><a href="javascript:void(0)"><i
                            class="ft-list"></i><span class="menu-title" data-i18n="">Projects</span></a>
                <ul class="menu-content">
                    <li class="myproject_view"><a class="menu-item " href="<?php echo base_url('index.php/project') ?>">View
                            Projects</a></li>
                    <li class="myproject_add"><a class="menu-item "
                                                 href="<?php echo base_url('/index.php/project/add_project') ?>">Add
                            Projects</a></li>
                </ul>
            </li>
