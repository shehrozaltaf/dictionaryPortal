    ...
    function h(e, f, g) {
        ...
        function p(b, c, d, e) {
            ...
            for (n(!0), h = i + 1; h <= o();) {
                ...
                if (h < i && (h = i + 1), void 0 === m().validPositions[h] && C(h) || void 0 !== l) h++; else {
                    var p = r(h);
        ...
        function v(b, c, d) {
            function e(c, d, f, h) {
                function j(f, h, l) {
                    ...
                    if (k === b && void 0 === f.matches) return n.push({match: f, locator: h.reverse(), cd: p}), !0;
                    if (void 0 !== f.matches) {
                        if (f.isGroup && l !== f) {
        ...
        function B(c, d, e, f, h) {
            ...
            function j(b, d, e) {
                ...
                return a.each(v(b), function (j, k) {
                    ...
                    if (d && (r += d), x(!0), h = null != l.fn ? l.fn.test(r, m(), b, e, g, i(c)) : (d === l.def || d === g.skipOptionalPartCharacter) && "" !== l.def && {
                        ...
                        return (h === !0 || void 0 !== h.pos || void 0 !== h.c) && (j > 0 && n(!0), s(v, a.extend({}, k, {input: z(u, l, v)}), f, i(c)) || (h = !1), !1)
                    }
                }), h
            }
            ...
            function k(b, c, d) {
                ...
                if (void 0 !== h) {
                    ...
                    var w = m().validPositions[q], x = m().validPositions[q - 1];
            ...
            function l(b, c) {
                for (var d = m().validPositions[c], e = d.locator, f = e.length, g = b; g < c; g++) if (void 0 === m().validPositions[g] && !C(g, !0)) {
                    var h = v(g), i = h[0], j = -1;
                    a.each(h, function (a, b) {
                        for (var c = 0; c < f && (void 0 !== b.locator[c] && A(b.locator[c].toString().split(","), e[c].toString().split(","))); c++) j < c && (j = c, i = b)
                    }), s(g, a.extend({}, i, {input: i.match.placeholder || i.match.def}), !0)
                }
            }
            ...
            function s(b, c, d, e) {
                if (e || g.insertMode && void 0 !== m().validPositions[b] && void 0 === d) {
                    ...
                    for (f = j = b; f <= i; f++) {
                        var r = h[f];
                        if (void 0 !== r) for (var s = j; s < m().maskLength && (null == r.match.fn && l[f] && (l[f].match.optionalQuantifier === !0 || l[f].match.optionality === !0) || null != r.match.fn);) {
                            if (s++, p === !1 && h[s] && h[s].match.def === r.match.def) m().validPositions[s] = a.extend(!0, {}, h[s]), m().validPositions[s].input = r.input, u(s), j = s, k = !0; else if (t(s, r.match.def)) {
            ...
            var E = !1, G = a.extend(!0, {}, m().validPositions);
            if (u(w), i(c) && (P(void 0, b.keyCode.DELETE, c), w = m().p), w < m().maskLength && (E = j(w, d, e), (!e || f === !0) && E === !1)) {
                ...
                if (!I || null !== I.match.fn || I.match.def !== d && d !== g.skipOptionalPartCharacter) {
                    if ((g.insertMode || void 0 === m().validPositions[D(w)]) && !C(w, !0)) {
                        ...
                        for (var L = w + 1, M = D(w); L <= M; L++) if (E = j(L, d, e), E !== !1) {
                            l(w, L), w = L;
                            break
                        }
                    }
            ...
            return E === !1 && g.keepStatic && !e && h !== !0 && (E = k(w, d, e)), E === !0 && (E = {pos: w}), a.isFunction(g.postValidation) && E !== !1 && !e && f !== !0 && (E = !!g.postValidation(x(!0), E, g) && E), void 0 === E.pos && (E.pos = w), E === !1 && (n(!0), m().validPositions = a.extend(!0, {}, G)), E
        }
        ...
        function I(c, d, e, f, h, i) {
            function j() {
                var a = !1, b = w().slice(p, D(p)).join("").indexOf(l);
                if (b !== -1 && !C(p)) {
                    a = !0;
                    for (var c = w().slice(p, p + b), d = 0; d < c.length; d++) if (" " !== c[d]) {
                        a = !1;
                        break
                    }
                }
            ...
            var k = f.slice(), l = "", p = 0, q = void 0;
            if (n(), m().p = D(-1), !e) if (g.autoUnmask !== !0) {
                var s = w().slice(0, D(-1)).join(""), t = k.join("").match(new RegExp("^" + b.escapeRegex(s), "g"));
            ...
            if (a.each(k, function (b, d) {
                if (void 0 !== d) {
                    ...
                    var h = o(void 0, !0), i = m().validPositions[h], k = r(h + 1, i ? i.locator.slice() : void 0, h);
                    if (!j() || e || g.autoUnmask) {
        ...
        function P(c, d, e, f) {
            function h() {
                if (g.keepStatic) {
                    ...
                    if (d > -1) for (m().p = D(o(-1, !0)); b.length > 0;) {
        ...
        function Q(d) {
            var e = this, f = a(e), h = d.keyCode, i = K(e);
            if (h === b.keyCode.BACKSPACE || h === b.keyCode.DELETE || l && h === b.keyCode.BACKSPACE_SAFARI || d.ctrlKey && h === b.keyCode.X && !c("cut")) d.preventDefault(), P(e, h, i), G(e, x(!0), m().p, d, e.inputmask._valueGet() !== x().join("")), e.inputmask._valueGet() === w().join("") ? f.trigger("cleared") : N(x()) === !0 && f.trigger("complete"), g.showTooltip && (e.title = g.tooltip || m().mask); else if (h === b.keyCode.END || h === b.keyCode.PAGE_DOWN) {
                d.preventDefault();
                var j = D(o());
            ...
            g.onKeyDown.call(this, d, x(), K(e).begin, g), ma = a.inArray(h, g.ignorables) !== -1
        }

        function R(c, d, e, f, h) {
            var i = this, j = a(i), k = c.which || c.charCode || c.keyCode;
            if (!(d === !0 || c.ctrlKey && c.altKey) && (c.ctrlKey || c.metaKey || ma)) return k === b.keyCode.ENTER && da !== x().join("") && (da = x().join(""), setTimeout(function () {
                j.trigger("change")
            }, 0)), !0;
            if (k) {
                46 === k && c.shiftKey === !1 && "," === g.radixPoint && (k = 44);
                var l, o = d ? {begin: h, end: h} : K(i), p = String.fromCharCode(k);
                m().writeOutBuffer = !0;
                var q = B(o, p, f);
        ...
        function S(b) {
            ...
            if (j === (ia ? w().reverse() : w()).slice(0, i.begin).join("") && (j = ""), k === (ia ? w().reverse() : w()).slice(i.end).join("") && (k = ""), ia && (c = j, j = k, k = c), window.clipboardData && window.clipboardData.getData) h = j + window.clipboardData.getData("Text") + k; else {
        ...
        function V(a) {
            ...
            g.showMaskOnFocus && (!g.showMaskOnHover || g.showMaskOnHover && "" === c) ? b.inputmask._valueGet() !== x().join("") && G(b, x(), D(o())) : na === !1 && K(b, D(o())), g.positionCaretOnTab === !0 && setTimeout(function () {
                X.apply(this, [a])
            }, 0), da = x().join("")
        }
            ...
            function c(b) {
                if ("" !== g.radixPoint) {
                    ...
                    if (void 0 === c[b] || c[b].input === H(b)) {
                        ...
                        if (d !== -1) {
                            for (var e in c) if (d < e && c[e].input !== H(e)) return !1;
                            return !0
                        }
                    }
                }
            ...
            setTimeout(function () {
                if (document.activeElement === d) {
                    ...
                    if (b.begin === b.end) switch (g.positionCaretOnClick) {
                        ...
                        default:
                            var f = b.begin, h = o(f, !0), i = D(h);
                            if (f < i) K(d, C(f) || C(f - 1) ? f : D(f)); else {
                                var j = H(i);
        ...
        function Z(c) {
            var d = this, e = a(d), f = K(d), h = c.originalEvent || c, i = window.clipboardData || h.clipboardData,
        ...
        function _(a) {
            var b = this;
            na = !0, document.activeElement !== b && g.showMaskOnHover && b.inputmask._valueGet() !== x().join("") && G(b, x())
        }
        ...
        var da, ea, fa, ga, ha, ia = !1, ja = !1, ka = !1, la = !1, ma = !1, na = !0, oa = {
            on: function (c, d, e) {
                var f = function (c) {
        ...
        if (void 0 !== e) switch (e.action) {
            ...
            case"getemptymask":
                return w().join("");
            case"remove":
                ea = e.el, fa = a(ea), f = ea.inputmask.maskset, g = ea.inputmask.opts, ea.inputmask._valueSet(J(ea)), oa.off(ea);
                var sa;
        ...
        numeric: {
            ...
            postFormat: function (c, d, e) {
                ...
                if (j = j.replace(new RegExp(b.escapeRegex(e.suffix) + "$"), ""), j = j.replace(new RegExp("^" + b.escapeRegex(e.prefix)), ""), j.length > 0 && e.autoGroup || j.indexOf(e.groupSeparator) !== -1) {
                    ...
                    if (j = "" === e.radixPoint ? j : m[0], h !== e.negationSymbol.front && (j = j.replace("!", "?")), j.length > e.groupSize) for (var n = new RegExp("([-+]?[\\d?]+)([\\d?]{" + e.groupSize + "})"); n.test(j) && "" !== e.groupSeparator;) j = j.replace(n, "$1" + e.groupSeparator + "$2"), j = j.replace(e.groupSeparator + e.groupSeparator, e.groupSeparator);
            ...
            signHandler: function (a, b, c, d, e) {
                if (!d && e.allowMinus && "-" === a || e.allowPlus && "+" === a) {
                    ...
                    if (f && f[0].length > 0) return b.buffer[f.index] === ("-" === a ? "+" : e.negationSymbol.front) ? "-" === a ? "" !== e.negationSymbol.back ? {
                        ...
                        pos: f.index, c: e.negationSymbol.front,
                        caret: c + 1
