!function (n, e, s) {
    ...
    s(n).on("load", function () {
        ...
        !1 === s.app.nav.initialized && s.app.nav.init({speed: 300}), Unison.on("change", function (e) {
            s.app.menu.change()
        });
        var e = s(".main-menu").data("img"), n = s(".navigation-background1");
        ...
        var i = s(".chartjs"), o = i.children("canvas").attr("height");
    ...
    }), s(".navigation").find("li").has("ul").addClass("has-sub"), s(".carousel").carousel({interval: 2e3}), s(".nav-link-expand").on("click", function (e) {
