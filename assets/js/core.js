...
function returnMsg(divTextId, TextMsg, divTextclass, divmain) {
    // altair_helpers.content_preloader_hide();
    $('#' + divTextId).removeClass('danger').removeClass('success').addClass(divTextclass).html(TextMsg).css('display', 'block');
    $('#' + divmain).css('display', 'block');
    setTimeout(function () {
        $('#' + divTextId).removeClass(divTextclass).html('').css('display', 'none');
