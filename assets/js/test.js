...
!function (q) {
    ...
    var R = function (n) {
        ...
        }, X = l("string"), _ = l("object"), O = l("array"), H = l("null"), B = l("boolean"), P = l("function"),
        L = l("number"), V = Array.prototype.slice, I = Array.prototype.indexOf, F = Array.prototype.push,
        Y = function (e, t) {
    ...
    function Ve(e) {
        var t = e !== undefined ? e.dom() : q.document, n = t.body.scrollLeft || t.documentElement.scrollLeft,
    ...
    function Ue(e, t, n, r) {
        return {x: W(e), y: W(t), width: W(n), height: W(r), right: W(e + n), bottom: W(t + r)}
    }
    ...
    function Ke(e, t, n) {
        if (!(X(n) || B(n) || L(n))) throw q.console.error("Invalid call to Attr.set. Key ", t, ":: Value ", n, ":: Element ", e), new Error("Attribute value was not simple");
        e.setAttribute(t, n + "")
    }
    ...
    function Ze(e, t) {
        var n = e.dom(), r = q.window.getComputedStyle(n).getPropertyValue(t), o = "" !== r || Pe(e) ? r : nn(n, t);
    ...
    var tt, nt, rt, ot, it = function (e) {
            ...
            fromHtml: function (e, t) {
                ...
                if (n.innerHTML = e, !n.hasChildNodes() || 1 < n.childNodes.length) throw q.console.error("HTML does not have a single root node", e), new Error("HTML must have a single root node");
            ...
            name: "Chrome", versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, zt], search: function (e) {
            ...
            name: "Safari", versionRegexes: [zt, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: function (e) {
        ...
        }], St = {browsers: W(Et), oses: W(Nt)}, kt = ut(function (e, t) {
            var n = St.browsers(), r = St.oses(), o = wt(n, e).fold(ht.unknown, ht.nu),
        ...
        }, Mt = (q.Node.ATTRIBUTE_NODE, q.Node.CDATA_SECTION_NODE, q.Node.COMMENT_NODE, q.Node.DOCUMENT_NODE),
        Rt = (q.Node.DOCUMENT_TYPE_NODE, q.Node.DOCUMENT_FRAGMENT_NODE, q.Node.ELEMENT_NODE), Dt = q.Node.TEXT_NODE,
        _t = (q.Node.PROCESSING_INSTRUCTION_NODE, q.Node.ENTITY_REFERENCE_NODE, q.Node.ENTITY_NODE, q.Node.NOTATION_NODE, Rt),
        ...
        }, Lt = ("undefined" != typeof q.window ? q.window : Function("return this;")(), Be(Rt)), Vt = Be(Dt),
        It = function (n, r) {
            return {
                left: W(n), top: W(r), translate: function (e, t) {
                    return It(n + e, r + t)
                }
            }
        }, Ft = It, Ut = function (e) {
            ...
            var r = e === undefined ? q.window : e, t = r.document, o = Ve(at.fromDom(t));
            return function (e) {
        ...
        }, $t = je(1), Wt = qe(["textarea", "input"]), Kt = je(3), Xt = je(8), Yt = je(9), Gt = je(11), Zt = qe(["br"]),
        Jt = $e("true"), Qt = $e("false"), en = {
            isText: Kt,
            isElement: $t,
            isComment: Xt,
            isDocument: Yt,
    ...
    var ln, fn, dn, hn = un.exports.boltExport, mn = function (e) {
        ...
        return {
            is: function (e) {
                return n === e
            }, isValue: a, isError: s, getOr: W(n), getOrThunk: W(n), getOrDie: W(n), or: function (e) {
                return bn(n)
            }, orThunk: function (e) {
                return bn(n)
            }, fold: function (e, t) {
        ...
        return {
            is: s, isValue: s, isError: a, getOr: K, getOrThunk: function (e) {
                return e()
            }, getOrDie: function () {
                return function (e) {
                    return function () {
                ...
                return Cn(e(n))
            }, each: u, bind: function (e) {
                return Cn(n)
            }, exists: s, forall: a, toOption: D.none
        }
    }, wn = {
    ...
    function Rn(e, t) {
        return "number" != typeof t && (t = 0), q.setTimeout(e, t)
    }

    function Dn(e, t) {
        return "number" != typeof t && (t = 1), q.setInterval(e, t)
    }
    ...
    function _n(n, r) {
        ...
        return (e = function () {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            q.clearTimeout(o), o = Rn(function () {
                n.apply(this, e)
            }, r)
        }).stop = function () {
            q.clearTimeout(o)
    ...
    var Ln = {
            requestAnimationFrame: function (e, t) {
                dn ? dn.then(e) : dn = new xn(function (e) {
                    !function (e, t) {
                        ...
                        for (n = 0; n < o.length && !r; n++) r = q.window[o[n] + "RequestAnimationFrame"];
                        (r = r || function (e) {
                            q.window.setTimeout(e, 0)
                        })(e, t)
                    }(e, t = t || q.document.body)
                }).then(e)
            }, setTimeout: Rn, setInterval: Dn, setEditorTimeout: function (e, t, n) {
                return Rn(function () {
                    e.removed || t()
                }, n)
        ...
        }, Vn = q.navigator.userAgent, In = de(), Fn = In.browser, Un = In.os, jn = In.deviceType,
        ...
        Wn = -1 !== Vn.indexOf("Windows Phone"), Kn = {
            ...
            trim: Bn, isArray: Yn.isArray, is: Pn, toArray: Yn.toArray, makeMap: function (e, t, n) {
                var r;
                for (t = t || ",", "string" == typeof (e = e || []) && (e = e.split(t)), n = n || {}, r = e.length; r--;) n[e[r]] = {};
                return n
            }, each: Yn.each, map: Yn.map, grep: Yn.filter, inArray: Yn.indexOf, hasOwn: function (e, t) {
            ...
            }, walk: Zn, createNS: function (e, t) {
                var n, r;
                for (t = t || q.window, e = e.split("."), n = 0; n < e.length; n++) t[r = e[n]] || (t[r] = {}), t = t[r];
                return t
            }, resolve: function (e, t) {
                var n, r;
                for (t = t || q.window, n = 0, r = (e = e.split(".")).length; n < r && (t = t[e[n]]); n++) ;
                return t
    ...
    var rr, or, ir, ar = Qn(["h1", "h2", "h3", "h4", "h5", "h6"]),
        ...
        dr = Qn(["thead", "tbody", "tfoot"]), hr = Qn(["td", "th"]), mr = Qn(["pre", "script", "textarea", "style"]),
        gr = function (e, t) {
    ...
    var kr = {
        ...
        }, Tr = {}, Ar = {}, Mr = Jn.makeMap, Rr = Jn.each, Dr = Jn.extend, _r = Jn.explode, Or = Jn.inArray,
        Hr = function (e, t) {
    ...
    function Ur(e, t) {
        ...
        if (r.target || (r.target = r.srcElement || q.document), Kn.experimentalShadowDom && (r.target = function (e, t) {
            if (e.composedPath) {
            ...
            var o = r.target.ownerDocument || q.document, i = o.documentElement, a = o.body;
    ...
    function Jr() {
        this.domLoaded = !1, this.events = {}, this.count = 1, this.expando = "mce-data-" + (+new Date).toString(32), this.hasMouseEnterLeave = "onmouseenter" in q.document.documentElement, this.hasFocusIn = "onfocusin" in q.document.documentElement, this.count = 1
    }
    ...
    var eo, to, no, ro, oo, io, ao, uo, co, so, lo, fo, ho, mo, go, po, vo, yo, bo = "sizzle" + -new Date,
        Co = q.window.document, wo = 0, xo = 0, zo = ei(), Eo = ei(), No = ei(), So = function (e, t) {
            return e === t && (lo = !0), 0
        }, ko = typeof undefined, To = {}.hasOwnProperty, Ao = [], Mo = Ao.pop, Ro = Ao.push, Do = Ao.push, _o = Ao.slice,
        ...
        Io = new RegExp("^" + Ho + "*," + Ho + "*"), Fo = new RegExp("^" + Ho + "*([>+~]|" + Ho + ")" + Ho + "*"),
        Uo = new RegExp("=" + Ho + "*([^\\]'\"]*?)" + Ho + "*\\]", "g"), jo = new RegExp(Lo),
        qo = new RegExp("^" + Bo + "$"), $o = {
            ID: new RegExp("^#(" + Bo + ")"),
            CLASS: new RegExp("^\\.(" + Bo + ")"),
            TAG: new RegExp("^(" + Bo + "|[*])"),
        ...
        }, Wo = /^(?:input|select|textarea|button)$/i, Ko = /^h\d$/i, Xo = /^[^{]+\{\s*\[native \w/,
        Yo = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Go = /[+~]/, Zo = /'|\\/g,
    ...
    function di(m, g, p, v, y, e) {
        return v && !v[bo] && (v = di(v)), y && !y[bo] && (y = di(y, e)), ti(function (e, t, n, r) {
            var o, i, a, u = [], c = [], s = t.length, l = e || function h(e, t, n) {
                    ...
                    return n
                }(g || "*", n.nodeType ? [n] : n, []), f = !m || !e && g ? l : fi(l, u, m, n, r),
                d = p ? y || (e ? m : s || v) ? [] : t : f;
        ...
        if (!i) {
            ...
            (i = No(e, function a(p, v) {
                function e(e, t, n, r, o) {
                    var i, a, u, c = 0, s = "0", l = e && [], f = [], d = co, h = e || b && no.find.TAG("*", o),
                        m = wo += null == d ? 1 : Math.random() || .1, g = h.length;
    ...
    var zi = q.document, Ei = Array.prototype.push, Ni = Array.prototype.slice,
        Si = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, ki = Zr.Event, Ti = Jn.makeMap("children,contents,next,prev"),
        Ai = function (e, t, n, r) {
            var o;
        ...
        Di = {"for": "htmlFor", "class": "className", readonly: "readOnly"}, _i = {"float": "cssFloat"}, Oi = {},
        Hi = {}, Bi = /^\s*|\s*$/g, Pi = function (e) {
            return e ? 9 === e.nodeType ? e : e.ownerDocument : zi
        };
    bi.fn = bi.prototype = {
        constructor: bi, selector: "", context: null, length: 0, init: function (e, t) {
            var n, r, o = this;
            if (!e) return o;
    ...
    function Qi(a, u) {
        ...
        function f(e) {
            return "string" == typeof e && (e = l(e)), P(e)
        }
        ...
        function v(e, t, n, r) {
            var o, i = [], a = l(e);
            for (r = r === undefined, n = n || ("BODY" !== d().nodeName ? d().parentNode : null), Jn.is(t, "string") && (t = "*" === (o = t) ? function (e) {
                return 1 === e.nodeType
            } : function (e) {
                return p(e, o)
        ...
        function S(e) {
            if (en.isElement(e)) {
                ...
                if (r(e, "name") || r(e, "data-mce-bookmark") || t) return !0
            }
            return !1
        }
        ...
        var A = {}, M = q.window, R = {}, t = 0, e = function j(m, g) {
                void 0 === g && (g = {});
                var p, v = 0, y = {};
                ...
                function n(e, t, n) {
                    ...
                    if (e = Jn._addCacheSuffix(e), y[e] ? l = y[e] : (l = {
                        ...
                        if (l.status = 1, (u = m.createElement("link")).rel = "stylesheet", u.type = "text/css", u.id = "u" + v++, u.async = !1, u.defer = !1, s = (new Date).getTime(), g.contentCssCors && (u.crossOrigin = "anonymous"), g.referrerPolicy && tn(at.fromDom(u), "referrerpolicy", g.referrerPolicy), "onload" in u && !((h = q.navigator.userAgent.match(/WebKit\/(\d*)/)) && parseInt(h[1], 10) < 536)) u.onload = f, u.onerror = i; else {
                            if (0 < q.navigator.userAgent.indexOf("Firefox")) return (c = m.createElement("style")).textContent = '@import "' + e + '"', d(), void b(c);
                            f()
                        }
                        var h;
                        b(u), u.href = e
            ...
            }(a, {contentCssCors: u.contentCssCors, referrerPolicy: u.referrerPolicy}), D = [],
            _ = u.schema ? u.schema : Lr({}),
            O = Wr({url_converter: u.url_converter, url_converter_scope: u.url_converter_scope}, u.schema),
            H = u.ownEvents ? new Zr : Zr.Event, B = _.getBlockElements(), P = Fi.overrideDefaults(function () {
                return {context: a, element: U.getRoot()}
            }), L = kr.decode, V = kr.encodeAllRaw, I = function (e, t, n, r) {
                if (Jn.isArray(e)) {
                    for (var o = e.length, i = []; o--;) i[o] = I(e[o], t, n, r);
                    return i
                }
                return !u.collect || e !== a && e !== M || D.push([e, t, n, r]), H.bind(e, t, n, r || U)
            }, F = function (e, t, n) {
                var r;
                if (Jn.isArray(e)) {
                    r = e.length;
                    for (var o = []; r--;) o[r] = F(e[r], t, n);
                    return o
                }
                if (D && (e === a || e === M)) for (r = D.length; r--;) {
                    var i = D[r];
                ...
                getRect: function (e) {
                    var t, n;
                    return e = l(e), t = h(e), n = g(e), {x: t.x, y: t.y, w: n.w, h: n.h}
                },
                getSize: g,
                ...
                createHTML: function (e, t, n) {
                    var r, o = "";
                    for (r in o += "<" + e, t) t.hasOwnProperty(r) && null !== t[r] && "undefined" != typeof t[r] && (o += " " + r + '="' + V(t[r]) + '"');
                ...
                loadCSS: function (e) {
                    var n;
                    U === Qi.DOM || a !== q.document ? (e = e || "", n = a.getElementsByTagName("head")[0], $i(e.split(","), function (e) {
                        var t;
                        e = Jn._addCacheSuffix(e), R[e] || (R[e] = !0, t = x("link", ne(ne({
                            rel: "stylesheet",
                            type: "text/css",
                            href: e
                ...
                rename: function (t, e) {
                    var n;
                    return t.nodeName !== e.toUpperCase() && (n = x(e), $i(o(t), function (e) {
                        i(n, e.nodeName, r(t, e.nodeName))
                    }), N(n, t, !0)), n || t
                },
                ...
                isEmpty: function (e, t) {
                    ...
                    if (S(e)) return !1;
                    if (e = e.firstChild) {
                        var i = new Ui(e, e.parentNode), a = _ ? _.getWhiteSpaceElements() : {};
                        t = t || (_ ? _.getNonEmptyElements() : null);
                        do {
                            if (n = e.nodeType, en.isElement(e)) {
                            ...
                            if (8 === n) return !1;
                            if (3 === n && !Yi.test(e.nodeValue)) return !1;
                            if (3 === n && e.parentNode && a[e.parentNode.nodeName] && Yi.test(e.nodeValue)) return !1;
                            e = i.next()
                        } while (e)
                    }
                    return o <= 1
                ...
                split: function (e, t, n) {
                    var r, o, i, a = k();
                    if (e && t) return a.setStart(e.parentNode, Ji(e)), a.setEnd(t.parentNode, Ji(t)), r = a.extractContents(), (a = k()).setStart(t.parentNode, Ji(t) + 1), a.setEnd(e.parentNode, Ji(e) + 1), o = a.extractContents(), (i = e.parentNode).insertBefore(pr.trimNode(U, r), e), n ? i.insertBefore(n, e) : i.insertBefore(t, e), i.insertBefore(pr.trimNode(U, o), e), z(e), n || t
                },
                bind: I,
                unbind: F,
                fire: function (e, t, n) {
    ...
    (qi = Qi = Qi || {}).DOM = qi(q.document), qi.nodeIndex = Ji;
    var ea = Qi, ta = ea.DOM, na = Jn.each, ra = Jn.grep, oa = (ia.prototype._setReferrerPolicy = function (e) {
        this.settings.referrerPolicy = e
    }, ia.prototype.loadScript = function (e, t, n) {
        var r, o, i = ta;
        o = i.uniqueId(), (r = q.document.createElement("script")).id = o, r.type = "text/javascript", r.src = Jn._addCacheSuffix(e), this.settings.referrerPolicy && i.setAttrib(r, "referrerpolicy", this.settings.referrerPolicy), r.onload = function () {
    ...
    function da(n, r) {
        ...
        return {
            cancel: function () {
                null !== o && (q.clearTimeout(o), o = null)
            }, throttle: function () {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    ...
    function ha(n, r) {
        ...
        return {
            cancel: function () {
                ...
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                null !== o && q.clearTimeout(o), o = q.setTimeout(function () {
                    n.apply(null, e), o = null
                }, r)
            }
        }
    ...
    function Ma(r, e) {
        ...
        var n = r.selection.getRng(), o = at.fromDom(n.startContainer), i = at.fromDom(r.getBody()),
            a = e.fold(function () {
                return "." + su()
            }, function (e) {
                return "[" + lu() + '="' + e + '"]'
    ...
    function Ra(n, e) {
        ...
        var o = ut({}), r = function (e, t) {
            var n = o.get(), r = t(n.hasOwnProperty(e) ? n[e] : {listeners: [], previous: ut(D.none())});
            n[e] = r, o.set(n)
        }, t = ha(function () {
    ...
    function _a(e, t) {
        var n = ye(e).dom(), r = at.fromDom(n.createDocumentFragment()), o = function (e, t) {
            var n = (t || q.document).createElement("div");
    ...
    var cu, su = W("mce-annotation"), lu = W("data-mce-annotation"), fu = W("data-mce-annotation-uid"),
        du = function (e, t) {
        ...
        }, Cu = en.isContentEditableTrue, wu = en.isContentEditableFalse, xu = en.isBr, zu = en.isText,
        ...
        }, Ou = en.isElement, Hu = $a, Bu = en.matchStyleValues("display", "block table"),
        Pu = en.matchStyleValues("float", "left right"), Lu = Du(Ou, Hu, c(Pu)),
        Vu = c(en.matchStyleValues("white-space", "pre pre-line pre-wrap")), Iu = en.isText, Fu = en.isBr,
        Uu = ea.nodeIndex, ju = eu, qu = function (e) {
    ...
    function Ku(t, n, e) {
        ...
        return {
            container: W(t), offset: W(n), toRange: function () {
                var e;
    ...
    function ic(e, t, n) {
        ...
        return a ? {name: o = a.tagName, index: tc(n.dom, o, a)} : function (e, t, n, r) {
            var o = t.dom, i = {};
    ...
    function vc(e, t) {
        return Gc(e) && t.container() === e ? function (e, t) {
            var n = mc(e.data.substr(0, t.offset())), r = mc(e.data.substr(t.offset())), o = n.text + r.text;
    ...
    function Cc(e, i, a, t) {
        ...
        return {
            show: function (t, e) {
                ...
                return c.set(D.some({caret: o, element: e, before: t})), c.get().each(function (e) {
    ...
    var Lc, Vc, Ic = Ku, Fc = en.isText, Uc = en.isBogus, jc = ea.nodeIndex, qc = function (e) {
            ...
            getBookmark: function (e, t, n) {
                return 2 === t ? ic(gu.trim, n, e) : 3 === t ? function (e) {
                    var t = e.getRng();
                    return {start: Gu(e.dom.getRoot(), Ic.fromRangeStart(t)), end: Gu(e.dom.getRoot(), Ic.fromRangeEnd(t))}
                }(e) : t ? function (e) {
                    return {rng: e.getRng()}
                }(e) : uc(e, !1)
            }, getUndoBookmark: w(ic, K, !0), getPersistentBookmark: uc
        ...
        }, Ps = de().browser, Ls = en.isContentEditableFalse, Vs = en.isContentEditableFalse,
        Is = en.matchStyleValues("display", "block table table-cell table-caption list-item"), Fs = Va, Us = Pa,
        js = en.isElement, qs = $a, $s = w(Mc, !0), Ws = w(Mc, !1);
    ...
    function Nl(i, e, t, n, a, r) {
        ...
        return o(t, n, zl).bind(function (e) {
            ...
            return u ? D.some({container: u, offset: a ? 0 : u.length}) : D.none()
        })
    }
    ...
    var Rl, Dl = en.isContentEditableFalse, _l = en.isText, Ol = en.isElement, Hl = en.isBr, Bl = $a,
        Pl = function (e) {
            ...
            return (zc(e) && u.isAtEnd() || Ec(e) && u.isAtStart()) && (r = Sc(r, e, W(!0), n, !0), Ll(r, n)) ? Xs(e, r) : (o = Sc(r, e, Ll, n), !(a = Yn.last(j(function (e, t) {
    ...
    function uf(n, e, t, r, o) {
        ...
        var u = [], c = af(n.getDoc(), o, t, r), s = ut(D.none()), l = function (e) {
    ...
    function cf(o, i, a, u) {
        o.undoManager.transact(function () {
            ...
            if (e.collapsed && function (e, t) {
                ...
                var n = Kc.getPersistentBookmark(o.selection, !1), r = o.selection.getRng();
    ...
    function sf(r) {
        ...
        return {
            register: function (e, t) {
                ...
                var t = function (e, t) {
                    var n = at.fromDom(e.getBody()), r = wa(n, "[" + lu() + '="' + t + '"]'), o = {};
                    return U(r, function (e) {
                        var t = Ye(e, fu()), n = o.hasOwnProperty(t) ? o[t] : [];
                        o[t] = n.concat([e])
                    }), o
                }(r, e);
    ...
    var hf = function FN(n, r) {
        ...
        gf = {"#text": 3, "#comment": 8, "#cdata": 4, "#pi": 7, "#doctype": 10, "#document-fragment": 11},
        pf = (vf.create = function (e, t) {
            ...
            if (r) do {
                ...
                if (3 === r.type && r.parent && t[r.parent.name] && mf.test(r.value)) return !1;
                if (n && n(r)) return !1
            } while (r = lf(r, this));
            return !0
    ...
    function Cf(q, $) {
        ...
        return {
            parse: function (i, e) {
                ...
                var o, u, c, s, l, f, d, h, m, g, p, v, y, b, C, w, x, z, E, N, S, k, T, A, M, R, D, _, O, H = 0,
                    B = [], P = 0, L = kr.decode,
                ...
                for (M = new RegExp("<(?:(?:!--([\\w\\W]*?)--!?>)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:![Dd][Oo][Cc][Tt][Yy][Pp][Ee]([\\w\\W]*?)>)|(?:!(--)?)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)>)|(?:([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), R = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, g = $.getShortEndedElements(), A = q.self_closing_elements || $.getSelfClosingElements(), p = $.getBoolAttrs(), y = q.validate, m = q.remove_internals, O = q.fix_self_closing, D = $.getSpecialElements(), T = i + ">"; o = M.exec(T);) {
                    ...
                    if (H < o.index && X(L(i.substr(H, o.index - H))), u = o[7]) ":" === (u = u.toLowerCase()).charAt(0) && (u = u.substr(1)), t(u); else if (u = o[8]) {
                        ...
                        if (null !== j) {
                            if ("all" === j) {
                                H = yf($, i, M.lastIndex), M.lastIndex = H;
                                continue
                            }
                            C = !1
                        }
    ...
    function wf(e, t) {
        ...
        for (u = function (e, t) {
            ...
            return t.replace(n, "")
        }(e.getTempAttrs(), u), a = s.getShortEndedElements(); i = c.exec(u);) r = c.lastIndex, o = i[0].length, n = a[i[1]] ? r : md.findEndTag(s, u, r), u = u.substring(0, r - o) + u.substring(n), c.lastIndex = r - o;
        return gu.trim(u)
    }

    function xf(e, t, n) {
        var r;
        if (t.format = t.format ? t.format : "html", t.get = !0, t.getInner = !0, t.no_events || e.fire("BeforeGetContent", t), "raw" === t.format) r = Jn.trim(gd.trimExternal(e.serializer, n.innerHTML)); else if ("text" === t.format) r = gu.trim(n.innerText || n.textContent); else {
    ...
    function zf(e) {
        var u, c, s, l, f, d = [];
        return u = (e = e || {}).indent, c = pd(e.indent_before || ""), s = pd(e.indent_after || ""), l = kr.getEncodeFunc(e.entity_encoding || "raw", e.entities), f = "html" === e.element_format, {
    ...
    function Uf(r, e) {
        ...
        Md(t), t.on("focusin", function () {
            ...
            t = e.target, n && t.ownerDocument === q.document && (t === q.document.body || Ff(n, t) || r.focusedEditor !== n || (n.fire("blur", {focusedEditor: null}), r.focusedEditor = null))
        }, Rd.bind(q.document, "focusin", fd))
    }

    function jf(e, t) {
        e.focusedEditor === t.editor && (e.focusedEditor = null), e.activeEditor || (Rd.unbind(q.document, "focusin", fd), fd = null)
    }
    ...
    function Gf(e, t) {
        e.dom.setHTML(e.getBody(), t), function (r) {
            Pd(r) && ql.firstPositionIn(r.getBody()).each(function (e) {
                var t = e.getNode(), n = en.isTable(t) ? ql.firstPositionIn(t).getOr(e) : e;
    ...
    function Zf(t, n, r) {
        return void 0 === r && (r = {}), r.format = r.format ? r.format : "html", r.set = !0, r.content = Yf(n) ? "" : n, Yf(n) || r.no_events || (t.fire("BeforeSetContent", r), n = r.content), D.from(t.getBody()).fold(W(n), function (e) {
            return Yf(n) ? function (e, t, n, r) {
                Nf(e.parser.getNodeFilters(), e.parser.getAttributeFilters(), n);
                var o = Ef({validate: e.validate}, e.schema).serialize(n);
                return r.content = mr(at.fromDom(t)) ? o : Jn.trim(o), Gf(e, r.content), r.no_events || e.fire("SetContent", r), n
                ...
                return 0 === n.length || /^\s+$/.test(n) ? (i = '<br data-mce-bogus="1">', "TABLE" === t.nodeName ? n = "<tr><td>" + i + "</td></tr>" : /^(UL|OL)$/.test(t.nodeName) && (n = "<li>" + i + "</li>"), n = (o = us(e)) && e.schema.isValidChild(t.nodeName.toLowerCase(), o.toLowerCase()) ? (n = i, e.dom.createHTML(o, e.settings.forced_root_block_attrs, n)) : n || '<br data-mce-bogus="1">', Gf(e, n), e.fire("SetContent", r)) : ("raw" !== r.format && (n = Ef({validate: e.validate}, e.schema).serialize(e.parser.parse(n, {
                    isRootContent: !0,
                    insert: !0
                }))), r.content = mr(at.fromDom(t)) ? n : Jn.trim(n), Gf(e, r.content), r.no_events || e.fire("SetContent", r)), r.content
            }(t, e, n, r)
        })
    }
    ...
    function Qf(e) {
        if (!e.removed) {
            ...
            r && e.save({is_removing: !0}), e.removed = !0, e.unbindAllNativeEvents(), e.hasHiddenInput && o && Vd.remove(o.nextSibling), function (e) {
                e.fire("remove")
            }(e), e.editorManager.remove(e), !e.inline && r && function (e) {
                Vd.setStyle(e.id, "display", e.orgDisplay)
            }(e), function (e) {
                e.fire("detach")
            }(e), Vd.remove(e.getContainer()), Jf(t), Jf(n), e.destroy()
        }
    }

    function ed(e, t) {
        var n = e.selection, r = e.dom;
        e.destroyed || (t || e.removed ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), Jf(n), Jf(r)), function (e) {
            var t = e.formElement;
    ...
    function td(e) {
        var t = O(e) ? e.join(" ") : e, n = Y(X(t) ? t.split(" ") : [], se);
    ...
    function od(e, t, n, r) {
        var o = td(n.forced_plugins), i = td(r.plugins), a = function (e, t) {
            return nd(e, t) ? e.sections()[t] : {}
        }(t, "mobile"), u = a.plugins ? td(a.plugins) : i, c = function (e, t) {
    ...
    function id(e, t, n, r, o) {
        var i = e ? {
            mobile: function (e, t) {
                var n = {resize: !1, toolbar_mode: rd(e, "scrolling"), toolbar_sticky: !1};
                return ne(ne(ne({}, Xd), n), t ? {menubar: !1} : {})
            }(o, t)
        } : {}, a = function (n, e) {
            ...
            return Ud(t.t, t.f)
        }(["mobile"], Fd(i, o)), u = Jn.extend(n, r, a.settings(), function (e, t) {
    ...
    var fd, dd, hd, md = Cf, gd = {trimExternal: wf, trimInternal: wf}, pd = Jn.makeMap, vd = function (e, t) {
            t(e), e.firstChild && vd(e.firstChild, t), e.next && vd(e.next, t)
        }, yd = function (a) {
                ...
                u.push(o), n[o] = function () {
                    ...
                    return {
                        fold: function () {
                            ...
                            q.console.log(e, {constructors: u, constructor: o, params: n})
                        }
                    }
                }
            }), n
        }, bd = {create: he("start", "soffset", "finish", "foffset")},
        Cd = yd([{before: ["element"]}, {on: ["element", "offset"]}, {after: ["element"]}]),
        wd = (Cd.before, Cd.on, Cd.after, function (e) {
            return e.fold(K, K, K)
        }),
        xd = yd([{domRange: ["rng"]}, {relative: ["startSitu", "finishSitu"]}, {exact: ["start", "soffset", "finish", "foffset"]}]),
        zd = {
            ...
            var n = at.fromDom(e.getBody()), r = (Df(e) ? D.from(t) : D.none()).map(_f).filter(Rf(n));
            ...
            e.on("init", function () {
                e.inline && function (e, t) {
                    ...
                    ea.DOM.bind(q.document, "mouseup", n), e.on("remove", function () {
            ...
            e.on("AddEditor", w(Uf, e)), e.on("RemoveEditor", w(jf, e))
        }, _d = function (e) {
            var t = e.classList;
            ...
            e.removed || (t ? Hd(e) : function (t) {
                ...
                t.quirks.refreshContentEditable(), t.bookmark !== undefined && !1 === Xf(t) && Td(t).each(function (e) {
                ...
                if (t.$.contains(n, o)) return Wf(o), $f(t, r), Hd(t);
                t.inline || (Kn.opera || Wf(n), t.getWin().focus()), (Kn.gecko || t.inline) && (Wf(n), $f(t, r)), Hd(t)
            }(e))
        }, Pd = Xf, Ld = function (e) {
            ...
            for (var n = {}, r = 0; r < e.length; r++) {
                var o = e[r];
                for (var i in o) Id.call(o, i) && (n[i] = dd(n[i], o[i]))
            }
            return n
        }), Ud = he("sections", "settings"), jd = de().deviceType, qd = jd.isTouch(), $d = jd.isPhone(), Wd = jd.isTablet(),
        Kd = ["lists", "autolink", "autosave"], Xd = {table_grid: !1, object_resizing: !1, resize: !1}, Yd = (hd = {}, {
            add: function (e, t) {
                hd[e] = t
            }, get: function (e) {
                return hd[e] ? hd[e] : {icons: {}}
            }, has: function (e) {
                return te(hd, e)
            }
        }), Gd = w(sd, "clientWidth"), Zd = w(sd, "clientHeight"), Jd = w(ld, "margin-top"), Qd = w(ld, "margin-left"),
        eh = function (e, t, n) {
    ...
    function nh(n) {
        ...
        function t(t) {
            if (!n.removed && th(n)) return m(u, function (e) {
                return function (e, t) {
    ...
    var rh = xa.PluginManager, oh = xa.ThemeManager;
    ...
    function ih(n) {
        ...
        function a(t) {
            ...
            }(t), 0 === (c = j(c, function (e) {
                return e !== t
            })).length && n.focus()
        }

        function u(e) {
            n.editorManager.setActive(n), Nd(n);
            var t = e();
            return i(t), t
        }
    ...
    function ch(e, t, n) {
        !function (e, t, n) {
            e.fire(t, n)
        }(e, t, {message: n}), q.console.error(n)
    }
    ...
    var fh = function (e) {
        ...
        }, displayError: uh, initError: fh
    };

    function hh(e) {
        return {getBookmark: w(Wl, e), moveToBookmark: w(Kl, e)}
    }

    (hh = hh || {}).isBookmarkNode = Xl;

    function mh(r, a) {
        var u, c, s, l, f, d, h, m, g, p, v, y, i, b, C, w, x, z = a.dom, E = Jn.each, N = a.getDoc(), S = q.document,
        ...
        function n(e) {
            var t = e.target;
            !function (e, t) {
                if ("longpress" !== e.type && 0 !== e.type.indexOf("touch")) return M(e.target) && !ph(e.clientX, e.clientY, t);
                var n = e.touches[0];
        ...
        function _(e) {
            var t, n, r, o;
            t = e.screenX - d, n = e.screenY - h, b = t * f[2] + p, C = n * f[3] + v, b = b < 5 ? 5 : b, C = C < 5 ? 5 : C, (M(u) && !1 !== Hs(a) ? !vh.modifierPressed(e) : vh.modifierPressed(e)) && (k(t) > k(n) ? (C = T(b * y), b = T(C / y)) : (b = T(C / y), C = T(b * y))), z.setStyles(R(c), {
                width: b,
                height: C
    ...
    }, yh = en.isContentEditableFalse, bh = en.isContentEditableTrue;

    function Ch(e) {
        var t = at.fromDom(q.document), n = Ve(t), r = function (e, t) {
            var n = t.owner(e);
            return mm(t, n)
        }(e, gm), o = Ut(e), i = h(r, function (e, t) {
            var n = Ut(t);
    ...
    function xh(e, t) {
        var n = function (e) {
            ...
            var i = Le(r.pageYOffset, o.scrollTop), a = Le(r.pageXOffset, o.scrollLeft),
                u = Le(o.clientTop, n.clientTop), c = Le(o.clientLeft, n.clientLeft);
    ...
    function zh(e, t) {
        var n = function (e, t) {
            var n = Ne(e);
            if (0 === n.length || wh(e)) return {element: e, offset: t};
            if (t < n.length && !wh(n[t])) return {element: n[t], offset: 0};
            var r = n[n.length - 1];
            return wh(r) ? {element: e, offset: t} : "img" === He(r) ? {element: r, offset: 1} : Vt(r) ? {
                element: r,
                offset: rf(r).length
            } : {element: r, offset: Ne(r).length}
        }(e, t), r = at.fromHtml('<span data-mce-bogus="all">' + gu.ZWSP + "</span>");
        return Ae(n.element, r), xh(r, function () {
            return Pt(r)
        })
    }
    ...
    function Mh(e, t, n, r) {
        var o = e.dom().defaultView.innerHeight;
        Th(e, t, o, n, r);
        var i = Ch(n.element), a = qt(q.window);
    ...
    function Vh(o, e) {
        return nu(function (e) {
            ...
            var n = m(Em(o), w(ve, e)), r = m(Nm(o), w(ve, t));
    ...
    function qh(e, t) {
        for (var n = e.rows(), r = 0; r < n.length; r++) for (var o = n[r].cells(), i = 0; i < o.length; i++) if (ve(o[i], t)) return D.some(Tm(i, r));
        return D.none()
    }
    ...
    function Zh(e, t) {
        var n = at.fromDom(t.commonAncestorContainer), r = zm(n, e), o = j(r, function (e) {
            return er(e) || ar(e)
        }), i = Gh(r, t), a = o.concat(i.length ? i : function (t) {
    ...
    function em(e, o) {
        return function (e, t) {
            ...
            var t = o[0], n = o[o.length - 1], r = Am(e);
    ...
    function im(e, t, n, r, o) {
        ...
        for (var l, f, d = new Ui(o, s); a = d[r ? "prev" : "next"]();) {
            if ("false" === e.getContentEditableParent(a) || (f = u, Va(l = a) && !1 === tm(l, f, lc))) return D.none();
            if (en.isText(a) && 0 < a.nodeValue.length) return !1 === nm(a, u, "A") ? D.some(Ku(a, r ? a.nodeValue.length : 0)) : D.none();
    ...
    function am(e, t, n, r) {
        ...
        if (en.isElement(o) && i > o.childNodes.length - 1 && (c = !1), en.isDocument(o) && (o = f, i = 0), o === f) {
            if (c && (a = o.childNodes[0 < i ? i - 1 : 0])) {
                ...
                if (u[a.nodeName] || rm(a)) return D.none()
            }
            if (o.hasChildNodes()) {
                if (i = Math.min(!c && 0 < i ? i - 1 : i, o.childNodes.length - 1), o = o.childNodes[i], i = en.isText(o) && s ? o.data.length : 0, !t && o === f.lastChild && rm(o)) return D.none();
                if (function (e, t) {
                    for (; t && t !== e;) {
    ...
    var hm = function UN(r, o) {
    ...
    }, Sm = he("element", "width", "rows"), km = he("element", "cells"), Tm = he("x", "y"), Am = function (e) {
        var o = Sm(Ha(e), 0, []);
        ...
        return qh(n, e).bind(function (t) {
            return qh(n, r).map(function (e) {
                return function (e, t, n) {
                    var r = t.x(), o = t.y(), i = n.x(), a = n.y(), u = o < a ? $h(e, r, o, i, a) : $h(e, r, a, i, o);
        ...
        var n = function (e, t) {
            ...
            return (n = t.contextual ? Pm(at.fromDom(e.getBody()), a).dom() : r.cloneContents()) && o.appendChild(n), e.selection.serializer.serialize(o, t)
        }(e, t);
        ...
        }), n && r.collapse(!0), Vm(t, r) ? D.none() : D.some(r)
    }, Fm = function (e, t, n) {
        if ((n = function (e, t) {
            ...
            !function (r, e) {
                var t = D.from(e.firstChild).map(at.fromDom), n = D.from(e.lastChild).map(at.fromDom);
                r.deleteContents(), r.insertNode(e);
                var o = t.bind(we).filter(Vt).bind(um), i = n.bind(xe).filter(Vt).bind(um);
            ...
            }(r, r.createContextualFragment(n.content)), e.selection.setRng(r), bm(e, r), n.no_events || e.fire("SetContent", n)
    ...
    function qm(u, c, e, s) {
        ...
        var n, o, l, f, i = function p(i, n) {
            ...
            return (n = (n = wm(s, [n])[0]) || (o.createRange ? o.createRange() : o.body.createTextRange())).setStart && 9 === n.startContainer.nodeType && n.collapsed && (r = u.getRoot(), n.setStart(r, 0), n.setEnd(r, 0)), l && f && (0 === e(n.START_TO_START, n, l) && 0 === e(n.END_TO_END, n, l) ? n = f : f = l = null), n
        }, m = function (e, t) {
            var n, r;
            if (function (e) {
            ...
            setCursorLocation: function (e, t) {
                var n = u.createRng();
                e ? (n.setStart(e, t), n.setEnd(e, t), m(n), a(!1)) : (Ih(u, n, s.getBody(), !0), m(n))
            },
            ...
            select: function (e, t) {
                return function (r, e, o) {
                    return D.from(e).map(function (e) {
                        ...
                        return n.setStart(e.parentNode, t), n.setEnd(e.parentNode, t + 1), o && (Ih(r, n, e, !0), Ih(r, n, e, !1)), n
                    })
                }(u, e, t).each(m), e
            },
            ...
            getNode: function () {
                return function (e, t) {
                    var n, r, o, i, a;
                    return t ? (r = t.startContainer, o = t.endContainer, i = t.startOffset, a = t.endOffset, n = t.commonAncestorContainer, !t.collapsed && (r === o && a - i < 2 && r.hasChildNodes() && (n = r.childNodes[i]), 3 === r.nodeType && 3 === o.nodeType && (r = r.length === i ? fm(r.nextSibling, !0) : r.parentNode, o = 0 === a ? fm(o.previousSibling, !1) : o.parentNode, r && r === o)) ? r : n && 3 === n.nodeType ? n.parentNode : n) : e
                }(s.getBody(), h())
            },
            getSel: d,
            setRng: m,
            ...
            getSelectedBlocks: function (e, t) {
                return function (e, t, n, r) {
                    var o, i, a = [];
                    if (i = e.getRoot(), n = e.getParent(n || sm(i, t, t.collapsed), e.isBlock), r = e.getParent(r || lm(i, t, t.collapsed), e.isBlock), n && n !== i && a.push(n), n && r && n !== r) for (var u = new Ui(o = n, i); (o = u.next()) && o !== r;) e.isBlock(o) && a.push(o);
                    return r && n !== r && r !== i && a.push(r), a
                }(u, h(), e, t)
            },
            normalize: function () {
                var e = h(), t = d();
                if (Om(t) || !Fh(s)) return e;
                var n = Im(u, e);
        ...
        return n = gh(g), o = mh(g, s), g.bookmarkManager = n, g.controlSelection = o, g
    }
    ...
    function Wm(e, t) {
        var n = Wr();
        t.convert_fonts_to_spans && $m(e, n, Jn.explode(t.font_size_legacy_values)), function (e, n) {
    ...
    function Ym(T, A) {
        ...
        var O = function (e) {
            ...
            schema: A, addAttributeFilter: function (e, n) {
                ...
                a = a || {}, D = {}, _ = {}, l = ug(og("script,style,head,html,body,title,meta,param"), A.getBlockElements());
                ...
                t = md({
                    ...
                    start: function (e, t, n) {
                        ...
                        if (n = v ? A.getElementRule(e) : {}) {
                            ...
                            if (f && C[e] && (f = !1), n.removeEmpty && Xm(A, g, C, d)) return i = d.parent, l[d.name] ? d.empty().remove() : d.unwrap(), void (d = i);
                            n.paddEmpty && (function (e) {
                                return rg(e, "#text") && e.firstChild.value === $r
                            }(d) || Xm(A, g, C, d)) && Km(T, a, l, d), d = d.parent
                        }
                    }
                }, A);
                ...
                if (t.parse(e, a.format), v && h.length && (a.context ? a.invalid = !0 : function (e) {
                    ...
                    for (d = og("tr,td,th,tbody,thead,tfoot,table"), l = A.getNonEmptyElements(), f = A.getWhiteSpaceElements(), h = A.getTextBlockElements(), m = A.getSpecialElements(), t = 0; t < e.length; t++) if ((n = e[t]).parent && !n.fixed) if (h[n.name] && "li" === n.parent.name) {
                        ...
                        if (r && 1 < o.length) {
                            ...
                            Xm(A, l, f, i) ? r.insert(n, o[0], !0) : (r.insert(i, o[0], !0), r.insert(n, i)), r = o[0], (Xm(A, l, f, r) || rg(r, "br")) && r.empty().remove()
                        } else if (n.parent) {
                            if ("li" === n.name) {
        ...
        return function (e, g) {
            ...
            g.remove_trailing_brs && e.addNodeFilter("br", function (e, t, n) {
                var r, o, i, a, u, c, s, l, f = e.length, d = Jn.extend({}, p.getBlockElements()),
                ...
                for (d.body = 1, r = 0; r < f; r++) if (i = (o = e[r]).parent, d[o.parent.name] && o === i.lastChild) {
                    ...
                    o && (o.remove(), Xm(p, h, m, i) && (s = p.getElementRule(i.name)) && (s.removeEmpty ? i.remove() : s.paddEmpty && Km(g, n, d, i)))
                } else {
                    for (a = o; i && i.firstChild === a && i.lastChild === a && !d[(a = i).name];) i = i.parent;
                    a === i && !0 !== g.padd_empty_with_br && ((l = new pf("#text", 3)).value = $r, o.replace(l))
                }
    ...
    function Jm(a, u) {
        var e = ["data-mce-selected"], c = u && u.dom ? u.dom : ea.DOM, s = u && u.schema ? u.schema : Lr(a);
        ...
        return cg(l, a, c), {
            ...
            serialize: function (e, t) {
                void 0 === t && (t = {});
                var n = ne({format: "html"}, t), r = lg(u, e, n), o = function (e, t, n) {
                    ...
                    var r = n.selection ? ne({forced_root_block: !1}, n) : n, o = e.parse(t, r);
                    return sg(o), o
                }(l, o, n);
    ...
    var ng = function (e, t) {
    ...
    }, og = Jn.makeMap, ig = Jn.each, ag = Jn.explode, ug = Jn.extend, cg = function (t, c, s) {
        ...
        return function (e, t) {
            ...
            var r, o, i, a = e.dom;
            return t = t.cloneNode(!0), (r = q.document.implementation).createHTMLDocument && (o = r.createHTMLDocument(""), Jn.each("BODY" === t.nodeName ? t.childNodes : [t], function (e) {
            ...
            findAll: function (e, n) {
                ...
                var r = Y(t, function (n) {
                    ...
                    var e = new xn(function (e, t) {
                        !function (n, r, o, t) {
                            var i, a;
                            0 !== r.src.indexOf("blob:") ? (i = hg(r.src).data, (a = n.findFirst(function (e) {
                                return e.base64() === i
                            })) ? o({image: r, blobInfo: a}) : fg(r.src).then(function (e) {
                                a = n.create(tg(), e, i), n.add(a), o({image: r, blobInfo: a})
                            }, function (e) {
                                t(e)
                            })) : (a = n.getByUri(r.src)) ? o({image: r, blobInfo: a}) : fg(r.src).then(function (t) {
                                dg(t).then(function (e) {
                                    i = hg(e).data, a = n.create(tg(), t, i), n.add(a), o({image: r, blobInfo: a})
                                })
                            }, function (e) {
                                t(e)
                            })
    ...
    function pg(c, a) {
        function n(e, t, n, r) {
            var o, i;
            (o = new q.XMLHttpRequest).open("POST", a.url), o.withCredentials = a.credentials, o.upload.onprogress = function (e) {
            ...
            }, (i = new q.FormData).append("file", e.blob(), e.filename()), o.send(i)
        }
    ...
    function vg(o) {
        ...
        var f, d, h = function () {
            var n = [], o = function (e) {
                ...
                return t = e.id || ep("blobid"), n = e.name || t, {
                    id: W(t),
                    name: W(n),
            ...
            return {
                create: function (e, t, n, r) {
                    if (X(e)) return o({id: e, name: r, blob: t, base64: n});
                    if (_(e)) return o(e);
                    ...
                    n = j(n, function (e) {
                        return e.blobUri() !== t || (q.URL.revokeObjectURL(e.blobUri()), !1)
                    })
                }, destroy: function () {
                    U(n, function (e) {
            ...
            return (d = d || gg(m, h)).findAll(o.getBody(), s).then(t(function (e) {
                return e = j(e, function (e) {
                    return "string" != typeof e || (dh.displayError(o, e), !1)
                }), U(e, function (e) {
    ...
    function wg(e, t, n, r, o, i) {
        ...
        if (s) if ("undefined" == typeof s.length) {
            for (a in s) if (s.hasOwnProperty(a)) {
                ...
                if ((!o || n.exact) && !op(u, vl(e, gl(s[a], i), a))) return
            }
    ...
    function xg(e, t, n, r) {
        var o;
        return r ? bg(e, r, t, n) : (r = e.selection.getNode(), !!bg(e, r, t, n) || !((o = e.selection.getStart()) === r || !bg(e, o, t, n)))
    }
    ...
    function zg(r, o, i) {
        ...
        return e = r.selection.getStart(), r.dom.getParent(e, function (e) {
            var t, n;
            for (t = 0; t < o.length; t++) n = o[t], !u[n] && ip(r, e, n, i) && (u[n] = !0, a.push(n))
        }, r.dom.getRoot()), a
    }
    ...
    function Sg(e) {
        ...
        return t === r && en.isText(t) ? 0 < n && n < t.nodeValue.length && (t = (r = Ng(t, n)).previousSibling, n < o ? (t = r = Ng(r, o -= n).previousSibling, o = r.nodeValue.length, n = 0) : o = 0) : (en.isText(t) && 0 < n && n < t.nodeValue.length && (t = Ng(t, n), n = 0), en.isText(r) && 0 < o && o < r.nodeValue.length && (o = (r = Ng(r, o).previousSibling).nodeValue.length)), {
            startContainer: t,
            startOffset: n,
            endContainer: r,
            endOffset: o
    ...
    function Ig(e, t, a) {
        ...
        return Pt(e), function (e, t, n, r) {
            ...
            return function (e, t, n) {
                ...
                e.appendData(t.data), Pt(at.fromDom(t)), n && Tg(e, r)
    ...
    function Fg(e) {
        return 0 < function (e) {
            for (var t = []; e;) {
                if (3 === e.nodeType && e.nodeValue !== fp || 1 < e.childNodes.length) return [];
    ...
    function jg(e) {
        ...
        return Xe(t, {id: dp, "data-mce-bogus": "1", "data-mce-type": "format-caret"}), e && Bt(t, at.fromText(fp)), t
    }

    function qg(e, t, n) {
        void 0 === n && (n = !0);
        var r = e.dom, o = e.selection;
        if (Fg(t)) lp(e, !1, at.fromDom(t), n); else {
            var i = o.getRng(), a = r.getParent(t, r.isBlock), u = function (e) {
                var t = Ug(e);
                return t && t.nodeValue.charAt(0) === fp && t.deleteData(0, 1), t
            }(t);
            i.startContainer === u && 0 < i.startOffset && i.setStart(u, i.startOffset - 1), i.endContainer === u && 0 < i.endOffset && i.setEnd(u, i.endOffset - 1), r.remove(t, !0), a && r.isEmpty(a) && np(at.fromDom(a)), o.setRng(i)
        }
    }
    ...
    function $g(e, t, n) {
        void 0 === n && (n = !0);
        var r = e.dom, o = e.selection;
        if (t) qg(e, t, n); else if (!(t = fc(e.getBody(), o.getStart()))) for (; t = r.get(dp);) qg(e, t, !1)
    }

    function Wg(e, t, n) {
        var r = e.dom, o = r.getParent(n, w(hl, e));
        o && r.isEmpty(o) ? n.parentNode.replaceChild(t, n) : (tp(at.fromDom(n)), r.isEmpty(n) ? n.parentNode.replaceChild(t, n) : r.insertAfter(t, n))
    }
    ...
    function Yg(t) {
        t.on("mouseup keydown", function (e) {
            !function (e, t) {
                ...
                $g(e, null, !1), 8 !== t && 46 !== t || !n.isCollapsed() || n.getStart().innerHTML !== fp || $g(e, fc(r, n.getStart())), 37 !== t && 39 !== t || $g(e, fc(r, n.getStart()))
            }(t, e.keyCode)
        })
    }
    ...
    var Zg, Jg, Qg = 0, ep = function (e) {
            ...
            if (s && t) for (a = 0; a < s.length; a++) if (i = s[a], Cg(e.dom, t, i) && wg(l, t, i, "attributes", o, r) && wg(l, t, i, "styles", o, r)) {
                if (c = i.classes) for (u = 0; u < c.length; u++) if (!e.dom.hasClass(t, c[u])) return;
                return i
            }
        }, ap = en.hasAttribute("data-mce-bookmark"), up = en.hasAttribute("data-mce-bogus"),
        cp = en.hasAttributeValue("data-mce-bogus", "all"), sp = function (e, t) {
            ...
            void 0 === r && (r = !0);
            var o = Bg(n, t.getBody(), e.dom()), i = Na(e, w(Lg, t), function (t) {
                return function (e) {
                    return e.dom() === t
                }
            }(t.getBody())), a = Ig(e, o, function (e, t) {
                return te(e.schema.getTextInlineElements(), He(t))
            }(t, e));
            t.dom.isEmpty(t.getBody()) ? (t.setContent(""), t.selection.setCursorLocation()) : i.bind(Vg).fold(function () {
                r && Pg(t, n, a)
            }, function (e) {
                r && Pg(t, n, D.some(e))
            })
    ...
    Jg = function (e) {
        ...
        t = en.matchNodeNames(["pre"]), r.collapsed || (n = e.selection.getSelectedBlocks(), gp(mp(mp(n, t), function (e) {
    ...
    function Cp(e, t, n, r, o) {
        var i = at.fromDom(t), a = at.fromDom(e.create(r, o)), u = n ? Ee(i) : ze(i);
    ...
    function xp(e, r, o, t, i) {
        ...
        if ("all" !== r.remove) {
            Hp(r.styles, function (e, t) {
                e = vl(a, gl(e, o), t), "number" == typeof t && (t = e, i = null), !r.remove_similar && i && !Bp(yl(a, i, t), e) || a.setStyle(u, t, ""), n = !0
            }), n && "" === a.getAttrib(u, "style") && (u.removeAttribute("style"), u.removeAttribute("data-mce-style")), Hp(r.attributes, function (e, t) {
                var n;
                if (e = gl(e, o), "number" == typeof t && (t = e, i = null), r.remove_similar || !i || Bp(a.getAttrib(i, t), e)) {
                    if ("class" === t && (e = a.getAttrib(u, t)) && (n = "", Hp(e.split(/\s+/), function (e) {
                        /mce\-\w+/.test(e) && (n += (n ? " " : "") + e)
                    }), n)) return void a.setAttrib(u, t, n);
                    "class" === t && u.removeAttribute("className"), Op.test(t) && u.removeAttribute("data-mce-" + t), u.removeAttribute(t)
                }
        ...
        return "none" !== r.remove ? (function (t, e, n) {
            ...
            n.block && (a ? o === i.getRoot() && (n.list_block && Bp(e, n.list_block) || Hp(Jn.grep(e.childNodes), function (e) {
                ml(t, a, e.nodeName.toLowerCase()) ? r ? r.appendChild(e) : (r = bp(i, e, a), i.setAttribs(r, t.settings.forced_root_block_attrs)) : r = 0
            })) : i.isBlock(e) && !i.isBlock(o) && (wp(i, e, !1) || wp(i, e.firstChild, !0, !0) || e.insertBefore(i.create("br"), e.firstChild), wp(i, e, !0) || wp(i, e.lastChild, !1, !0) || e.appendChild(i.create("br")))), n.selector && n.inline && !Bp(n.inline, e) || i.remove(e, !0)
        }(e, u, r), !0) : void 0
    }
    ...
    function zp(u, n, a, e, r) {
            ...
            return function (e, t, n, r, o, i, a, u) {
                ...
                if (n) {
                    for (h = n.parentNode, c = r.parentNode; c && c !== h; c = c.parentNode) {
                        for (s = m.clone(c, !1), d = 0; d < t.length; d++) if (xp(e, t[d], u, s, s)) {
                            s = 0;
                            break
                        }
        ...
        function t(e) {
            ...
            if (f.split) {
                if (o = Sg(o), (t = yp(u, o, !0)) !== (n = yp(u, o))) {
                    ...
                    }(n) && n.firstChild && (n = n.firstChild || n), vp(h, t, n)) {
                        var i = D.from(t.firstChild).getOr(t);
                        return c(Cp(h, i, !0, "span", {id: "_start", "data-mce-type": "bookmark"})), void s(!0)
                    }
                    if (vp(h, n, t)) {
                        i = D.from(n.lastChild).getOr(n);
                        return c(Cp(h, i, !1, "span", {id: "_end", "data-mce-type": "bookmark"})), void s(!1)
                    }
                    t = bp(h, t, "span", {id: "_start", "data-mce-type": "bookmark"}), n = bp(h, n, "span", {
                        id: "_end",
            ...
            nf(h, o, function (e) {
                Hp(e, function (e) {
                    g(e), en.isElement(e) && "underline" === u.dom.getStyle(e, "text-decoration") && e.parentNode && "underline" === bl(h, e.parentNode) && xp(u, {
                        deep: !1,
                        exact: !0,
                        inline: "span",
        ...
        var o, i, l = u.formatter.get(n), f = l[0], d = !0, h = u.dom, m = u.selection, g = function (e) {
            var t, n, r, o, i;
            if (en.isElement(e) && h.getContentEditable(e) && (o = d, d = "true" === h.getContentEditable(e), i = !0), t = Jn.grep(e.childNodes), d && !i) for (n = 0, r = l.length; n < r && !xp(u, l[n], a, e, e); n++) ;
            if (f.deep && t.length) {
        ...
        if (e) ll(e) ? ((i = h.createRng()).setStartBefore(e), i.setEndAfter(e), t(i)) : t(e); else if ("false" !== h.getContentEditable(m.getNode())) m.isCollapsed() && f.inline && !h.select("td[data-mce-selected],th[data-mce-selected]").length ? function (e, t, n, r) {
            ...
            if (s) if (u) {
                ...
                g = Sg(g), e.formatter.remove(t, n, g), d.moveToBookmark(a)
            } else {
                l = fc(e.getBody(), s);
                var p = jg(!1).dom(), v = Xg(h, p);
                Wg(e, p, l || s), qg(e, l, !1), d.setCursorLocation(v, 1), f.isEmpty(s) && f.remove(s)
            }
        }(u, n, a, r) : (o = Kc.getPersistentBookmark(u.selection, !0), t(m.getRng()), m.moveToBookmark(o), f.inline && xg(u, n, a, m.getStart()) && fl(h, m, m.getRng()), u.nodeChanged()); else {
            e = m.getNode();
    ...
    function Sp(e, t, n) {
        var r, o, i = new pp(e);
        if (t && n && (t = Np(t, "previousSibling"), n = Np(n, "nextSibling"), i.compare(t, n))) {
    ...
    function Tp(r, e, t) {
        return w(function (e, t, n) {
            r.setStyle(n, e, t), "" === n.getAttribute("style") && n.removeAttribute("style"), Vp(r, n)
        }, e, t)
    }
    ...
    function Rp(t) {
        var n = Ic.fromRangeStart(t), r = Ic.fromRangeEnd(t), o = t.commonAncestorContainer;
    ...
    var _p = Jn.each, Op = /^(src|href|style)$/, Hp = Jn.each, Bp = pl, Pp = Jn.each, Lp = function (e, t, n) {
        Pp(e.childNodes, function (e) {
            Ep(e) && (t(e) && n(e), e.hasChildNodes() && Lp(e, t, n))
        })
    }, Vp = function (e, t) {
        "SPAN" === t.nodeName && 0 === e.getAttribs(t).length && e.remove(t, !0)
    }, Ip = function (e) {
        return e.collapsed ? e : Rp(e)
    }, Fp = Jn.each, Up = function (m, g, p, r) {
        function v(n, e) {
            if (e = e || C, n) {
                if (e.onformat && e.onformat(n, e, p, r), Fp(e.styles, function (e, t) {
        ...
        function e(c, e, t, s) {
            ...
            l = C.inline || C.block, f = c.create(l), v(f), nf(c, e, function (e) {
                var a, u = function (e) {
                    ...
                    if (C.wrapper && ip(m, e, g, p)) a = 0; else {
                        if (h && !t && C.block && !C.wrapper && hl(m, r) && ml(m, o, l)) return e = c.rename(e, l), v(e), d.push(e), void (a = 0);
                        if (C.selector) {
                            var i = y(b, e);
                            if (!C.inline || i) return void (a = 0)
                        }
                        !h || t || !ml(m, l, r) || !ml(m, o, l) || !s && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0) || lc(e) || C.inline && c.isBlock(e) ? (a = 0, Fp(Jn.grep(e.childNodes), u), t && (h = n), a = 0) : (a || (a = c.clone(f, !1), e.parentNode.insertBefore(a, e), d.push(a)), a.appendChild(e))
                    }
                };
                Fp(e, u)
            }), !0 === C.links && Fp(d, function (e) {
                var t = function (e) {
                    "A" === e.nodeName && v(e, C), Fp(Jn.grep(e.childNodes), t)
                };
                t(e)
            }), Fp(d, function (e) {
                function t(e) {
                ...
                var n, r, o, i, a;
                (r = 0, Fp(e.childNodes, function (e) {
                    (function (e) {
                        return e && en.isText(e) && 0 === e.length
                    })(e) || Xl(e) || r++
                }), n = r, !(1 < d.length) && c.isBlock(e) || 0 !== n) ? (C.inline || C.wrapper) && (C.exact || 1 !== n || ((i = t(o = e)) && !Xl(i) && Cg(c, i, C) && (a = c.clone(i, !1), v(a), c.replace(a, o, !0), c.remove(i, !0)), e = a || o), Mp(m, b, p, e), function (t, n, r, o, i) {
                    ip(t, i.parentNode, r, o) && xp(t, n, o, i) || n.merge_with_parents && t.dom.getParent(i.parentNode, function (e) {
                        if (ip(t, e, r, o)) return xp(t, n, o, i), !0
                    })
                    ...
                    t.styles && (t.styles.color || t.styles.textDecoration) && (Jn.walk(r, w(Ap, e), "childNodes"), Ap(e, r))
                }(c, C, 0, e), function (e, t, n, r) {
                    "sub" !== t.inline && "sup" !== t.inline || (Lp(r, kp(e, "fontSize"), Tp(e, "fontSize", "")), e.remove(e.select("sup" === t.inline ? "sub" : "sup", r), !0))
                }(c, C, 0, e), function (e, t, n, r) {
                    r && !1 !== t.merge_siblings && (r = Sp(e, dl(r), r), r = Sp(e, r, dl(r, !0)))
        ...
        if ("false" !== i.getContentEditable(a.getNode())) {
            if (C) {
                if (r) ll(r) ? y(b, r) || ((n = i.createRng()).setStartBefore(r), n.setEndAfter(r), e(i, Al(m, n, b), 0, !0)) : e(i, r, 0, !0); else if (o && C.inline && !i.select("td[data-mce-selected],th[data-mce-selected]").length) !function (e, t, n) {
                    ...
                    a = (r = s.getRng()).startOffset, c = r.startContainer.nodeValue, (o = fc(e.getBody(), s.getStart())) && (i = Ug(o));
                    var l = /[^\s\u00a0\u00ad\u200b\ufeff]/;
                    c && 0 < a && a < c.length && l.test(c.charAt(a)) && l.test(c.charAt(a - 1)) ? (u = s.getBookmark(), r.collapse(!0), r = Al(e, r, e.formatter.get(t)), r = Sg(r), e.formatter.apply(t, n, r), s.moveToBookmark(u)) : (o && i.nodeValue === fp || (i = (o = function (e, t) {
                        return e.importNode(t, !0)
                    }(e.getDoc(), jg(!0).dom())).firstChild, r.insertNode(o), a = 1), e.formatter.apply(t, n, o), s.setCursorLocation(i, a))
                }(m, g, p); else {
                    var u = m.selection.getNode();
                    m.settings.forced_root_block || !b[0].defaultBlock || i.getParent(u, i.isBlock) || Up(m, b[0].defaultBlock), m.selection.setRng(Ip(m.selection.getRng())), t = Kc.getPersistentBookmark(m.selection, !0), e(i, Al(m, a.getRng(), b)), a.moveToBookmark(t), fl(i, a, a.getRng()), m.nodeChanged()
                }
                !function (e, t) {
                    gp(hp[e], function (e) {
                        e(t)
        ...
        var o = J(t.get()), i = {}, a = {}, u = j(Cl(r.dom, e), function (e) {
        ...
        N(n, function (e, n) {
            Jn.each(u, function (t) {
                ...
                }), i[n] = e.callbacks), a[n] = e.callbacks, !1) : !yg(r, t, n) && void 0
            })
        });
    ...
    function Wp(e, t) {
        function c(e) {
            ...
            return r = "string" == typeof e ? {name: e, classes: [], attrs: {}} : e, function (e, t) {
                t.classes.length && Kv.addClass(e, t.classes.join(" ")), Kv.setAttribs(e, t.attrs)
            }(t = Kv.create(r.name), r), t
        }
        ...
        var n, r, o, s = t && t.schema || Lr({}), l = function (n, e, t) {
            ...
            return o && (r = c(o)).appendChild(n), t && (r || (r = Kv.create("div")).appendChild(n), Jn.each(t, function (e) {
                var t = c(e);
                r.insertBefore(t, n)
            })), l(r, e, o && o.siblings)
        };
        return e && e.length ? (r = e[0], n = c(r), (o = Kv.create("div")).appendChild(l(n, e.slice(1), r.siblings)), o) : ""
    }
    ...
    function Xp(n, e) {
        ...
        return "preview" in e && !1 === (u = e.preview) ? "" : (t = e.block || e.inline || "span", r = (i = function (e) {
            return e && "string" == typeof e ? (e = (e = e.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"), Jn.map(e.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
                var t = Jn.map(e.split(/(?:~\+|~|\+)/), Kp), n = t.pop();
                return t.length && (n.siblings = t), n
            }).reverse()) : []
        }(e.selector)).length ? (i[0].name || (i[0].name = t), t = e.selector, Wp(i, n)) : Wp([t], n), o = Kv.select(t, r)[0] || r.firstChild, Wv(e.styles, function (e, t) {
            (e = s(e)) && Kv.setStyle(o, t, e)
        }), Wv(e.attributes, function (e, t) {
            (e = s(e)) && Kv.setAttrib(o, t, e)
        }), Wv(e.classes, function (e) {
            e = s(e), Kv.hasClass(o, e) || Kv.addClass(o, e)
        }), n.fire("PreviewFormats"), Kv.setStyles(r, {
            position: "absolute",
            left: -65535
        }), n.getBody().appendChild(r), a = Kv.getStyle(n.getBody(), "fontSize", !0), a = /px$/.test(a) ? parseInt(a, 10) : 0, Wv(u.split(" "), function (e) {
            var t = Kv.getStyle(o, e, !0);
            if (!("background-color" === e && /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) && (t = Kv.getStyle(n.getBody(), e, !0), "#ffffff" === Kv.toHex(t).toLowerCase()) || "color" === e && "#000000" === Kv.toHex(t).toLowerCase())) {
        ...
        }), n.fire("AfterPreviewFormats"), Kv.remove(r), c)
    }
    ...
    function Gp(e) {
        var t = function o(e) {
            ...
            return r($p(e.dom)), r(e.settings.formats), {
                get: function (e) {
                    return e ? n[e] : n
                }, has: function (e) {
                    return te(n, e)
    ...
    function Jp(e, t, n) {
        var r = function (e) {
            var t, n, r;
            for (r = q.document.createElement("div"), t = q.document.createDocumentFragment(), e && (r.innerHTML = e); n = r.firstChild;) t.appendChild(n);
            return t
        }(t);
    ...
    function nv(e) {
        var t = at.fromTag("body", ty.get().getOrThunk(function () {
            ...
            return ty.set(D.some(e)), e
        }));
        return _a(t, tv(e)), U(wa(t, "*[data-mce-bogus]"), Oe), function (e) {
    ...
    function av(n) {
        var r = ut(D.none()), o = ut(0), i = ut(0), a = {
            data: [], typing: !1, beforeChange: function () {
                ...
                return function (e, t, n, r, o, i, a) {
                    var u = e.settings, c = ny(e);
                    if (i = i || {}, i = Jn.extend(i, c), !1 === rv(r) || e.removed) return null;
                    var s = t.data[n.get()];
                ...
                return function (e, t, n, r) {
                    var o;
                    return t.typing && (t.add(), t.typing = !1, ov(t, !1, n)), 0 < r.get() && (r.set(r.get() - 1), o = t.data[r.get()], ry(e, o, !0), e.setDirty(!0), e.fire("Undo", {level: o})), o
                }(n, a, o, i)
            }, redo: function () {
                return function (e, t, n) {
                    var r;
                    return t.get() < n.length - 1 && (t.set(t.get() + 1), r = n[t.get()], ry(e, r, !1), e.setDirty(!0), e.fire("Redo", {level: r})), r
                }(n, i, a.data)
            }, clear: function () {
                !function (e, t, n) {
                ...
                return function (e, t, n) {
                    return iv(e, t), e.beforeChange(), e.ignore(n), e.add()
                }(a, o, e)
            }, ignore: function (e) {
                !function (e, t) {
                    try {
                ...
                !function (e, t, n, r, o) {
                    if (t.transact(r)) {
                        ...
                        ry(e, a, !0), t.transact(o) && (t.data[n.get() - 1].beforeBookmark = i)
                    }
                }(n, a, i, e, t)
            }
        };
        return function (n, r, o) {
            ...
            n.on("init", function () {
                ...
                var t = e.keyCode;
                e.isDefaultPrevented() || ((33 <= t && t <= 36 || 37 <= t && t <= 40 || 45 === t || e.ctrlKey) && (i(), n.nodeChanged()), 46 !== t && 8 !== t || n.nodeChanged(), a.get() && r.typing && !1 === oy(ny(n), r.data[0]) && (!1 === n.isDirty() && (n.setDirty(!0), n.fire("change", {
                    level: r.data[0],
                    lastLevel: null
                ...
                if (!e.isDefaultPrevented()) if (33 <= t && t <= 36 || 37 <= t && t <= 40 || 45 === t) r.typing && i(e); else {
                    ...
                    !(t < 16 || 20 < t) || 224 === t || 91 === t || r.typing || n || (r.beforeChange(), ov(r, !0, o), r.add({}, e), a.set(!0))
                }
    ...
    function sv(o) {
        var i = o.dom, a = us(o), u = Bs(o), c = function (e, t) {
            if (!function (e) {
                ...
                "" !== i.getAttrib(n, ay) === r && !t || (i.setAttrib(n, ay, r ? u : null), i.setAttrib(n, "aria-placeholder", r ? u : null), function (e, t) {
        ...
        u && o.on("init", function (e) {
            c(e, !0), o.on("change SetContent ExecCommand", c), o.on("remove", function () {
                var e = o.getBody();
                i.setAttrib(e, ay, null), i.setAttrib(e, "aria-placeholder", null)
            })
        })
    }
    ...
    function hv(e) {
        var t, n, r, o, i, a, u, c, s, l, f = e.dom, d = e.selection, h = e.schema, m = h.getBlockElements(),
            g = d.getStart(), p = e.getBody(), v = us(e);
        if (g && en.isElement(g) && v && (l = p.nodeName.toLowerCase(), h.isValidChild(l, v.toLowerCase()) && !function (t, e, n) {
            ...
            for (n = (t = d.getRng()).startContainer, r = t.startOffset, o = t.endContainer, i = t.endOffset, s = Pd(e), g = p.firstChild; g;) if (y = m, b = g, en.isText(b) || en.isElement(b) && !fv(y, b) && !Xl(b)) {
                if (dv(m, g)) {
    ...
    function vv(e, t) {
        return e ? function (e) {
            if (sy(e.previousSibling)) return gv(e.previousSibling) || e.previousSibling.appendData(gu.ZWSP), e.previousSibling;
            if (sy(e)) return mv(e) || e.insertData(0, gu.ZWSP), e;
            var t = pv(e);
            return e.parentNode.insertBefore(t, e), t
        }(t) : function (e) {
            if (sy(e.nextSibling)) return mv(e.nextSibling) || e.nextSibling.insertData(0, gu.ZWSP), e.nextSibling;
            if (sy(e)) return gv(e) || e.appendData(gu.ZWSP), e;
            var t = pv(e);
    ...
    function xv(e, t, n) {
        var r = my.normalizeForwards(n), o = wv(t, r.container());
    ...
    function kv(e, t, n) {
        var r = my.normalizeBackwards(n), o = wv(t, r.container());
        return my.findRootInline(e, o, r).fold(function () {
    ...
    function Hv(e, t, n, r) {
        var o = my.normalizePosition(e, r), i = Av(t, n, o);
    ...
    var qv, $v, Wv = Jn.each, Kv = ea.DOM, Xv = function (e) {
            ...
            return function (e, t) {
                var n = 0;
                U(e, function (e) {
                    e[0] === Yv ? n++ : e[0] === Zv ? (Jp(t, e[1], n), n++) : e[0] === Gv && function (e, t) {
            ...
            var e, t, r;
            return e = Qv(n.getBody()), function (e) {
            ...
            "fragmented" === t.type ? ey(t.fragments, e.getBody()) : e.setContent(t.content, {format: "raw"}), e.selection.moveToBookmark(n ? t.beforeBookmark : t.bookmark)
        }, oy = function (e, t) {
        ...
        iy = [9, 27, vh.HOME, vh.END, 19, 20, 44, 144, 145, 33, 34, 45, 16, 17, 18, 91, 92, 93, vh.DOWN, vh.UP, vh.LEFT, vh.RIGHT].concat(Kn.browser.isFirefox() ? [224] : []),
        ay = "data-mce-placeholder", uy = function (n) {
            ...
            n.on("touchstart", function (n) {
                lv(n).each(function (e) {
                    i.cancel();
                    var t = {x: W(e.clientX), y: W(e.clientY), target: W(n.target)};
                    i.throttle(n), o.set(!1), r.set(D.some(t))
                })
            }, !0), n.on("touchmove", function (e) {
                i.cancel(), lv(e).each(function (t) {
            ...
            return e.fold(function (e) {
                ...
                return ql.lastPositionIn(e).map(function (e) {
                    if (bv(e, n)) return Ic(n.get(), n.get().length - 1);
                    Jc.remove(n.get());
                    var t = yv(e, !1);
            ...
            return D.none()
        }, py = yd([{before: ["element"]}, {start: ["element"]}, {end: ["element"]}, {after: ["element"]}]),
        vy = function (e) {
            return e.fold(K, K, K, K)
        }, yy = Av, by = Hv, Cy = (w(Hv, !1), w(Hv, !0), Rv), wy = function (e) {
            return e.fold(py.start, py.start, py.end, py.end)
        }, xy = function (e, t) {
            var n = t.selection.getRng(), r = e ? Ic.fromRangeEnd(n) : Ic.fromRangeStart(n);
            return !!Bv(t) && (e && Fa(r) ? Pv(!0, t.selection, r) : !(e || !Ua(r)) && Pv(!1, t.selection, r))
        }, zy = {
            move: function (e, t, n) {
                return function () {
                    return !!Vv(e) && function (t, n, e) {
                        var r = t.getBody(), o = Ic.fromRangeStart(t.selection.getRng()), i = w(my.isInlineTarget, t);
                        return by(e, i, r, o).bind(function (e) {
                            return Fv(t, n, e)
                        })
                    }(e, t, n).isSome()
                }
            }, moveNextWord: w(Uv, !0), movePrevWord: w(Uv, !1), setupSelectedState: function (t) {
                var n = ut(null), r = w(my.isInlineTarget, t);
                return t.on("NodeChange", function (e) {
                    !Vv(t) || Kn.browser.isIE() && e.initial || (function (e, t, n) {
                        var r = j(t.select('*[data-mce-selected="inline-boundary"]'), e), o = j(n, e);
                        U(x(r, o), w(Iv, !1)), U(x(o, r), w(Iv, !0))
                    }(r, t.dom, e.parents), function (e, t) {
                        if (e.selection.isCollapsed() && !0 !== e.composing && t.get()) {
                            var n = Ic.fromRangeStart(e.selection.getRng());
                            Ic.isTextPosition(n) && !1 === my.isAtZwsp(n) && (Lv(e, Jc.removeAndReposition(t.get(), n)), t.set(null))
                        }
    ...
    ($v = qv = qv || {})[$v.Up = -1] = "Up", $v[$v.Down = 1] = "Down";

    function Ey(o, i, a, e, u, t) {
        function n(e) {
            var t, n, r;
            for (r = jv([e]), -1 === o && (r = r.reverse()), t = 0; t < r.length; t++) if (n = r[t], !a(n, c)) {
    ...
    function My(e, o) {
        return Yn.reduce(e, function (e, t) {
            var n, r;
            return n = Math.min(ky(e, o), Ty(e, o)), r = Math.min(ky(t, o), Ty(t, o)), Ay(o, t) ? t : Ay(o, e) ? e : r === n && Wy(t.node) ? t : r < n ? t : e
        })
    }

    function Ry(e, t, n, r) {
        for (; r = Ky(r, e, Wa, t);) if (n(r)) return
    }
    ...
    function Dy(e, t, n) {
        ...
        return (r = (r = My(i, t)) && My(function (e, r) {
            ...
            var o = [];
            return o.push(r), Ry(qv.Up, e, w(t, Ga), r.node), Ry(qv.Down, e, w(t, Za), r.node), o
        }(e, r), t)) && xc(r.node) ? function (e, t) {
            return {node: e.node, before: ky(e, t) < Ty(e, t)}
        }(r, t) : null
    }
    ...
    function Hy(e, t, n) {
        var r = Dc(1, e.getBody(), t), o = Ic.fromRangeStart(r), i = o.getNode();
        if (Yy(i)) return _y(1, e, i, !o.isAtEnd(), !1);
        var a = o.getNode(!0);
        if (Yy(a)) return _y(1, e, a, !1, !1);
    ...
    var Uy, jy, qy = w(Ey, qv.Up, Ga, Za), $y = w(Ey, qv.Down, Za, Ga), Wy = en.isContentEditableFalse, Ky = Sc,
        Xy = en.isContentEditableTrue, Yy = en.isContentEditableFalse, Gy = w(Py, !0, cl), Zy = w(Py, !1, cl),
        Jy = Vy(!0, Iy), Qy = Vy(!1, Iy), eb = Vy(!0, en.isTable), tb = Vy(!1, en.isTable), nb = Vy(!0, Fy),
        rb = Vy(!1, Fy);
    (jy = Uy = Uy || {})[jy.Br = 0] = "Br", jy[jy.Block = 1] = "Block", jy[jy.Wrap = 2] = "Wrap", jy[jy.Eol = 3] = "Eol";
    ...
    function ib(e, t, n, r) {
        for (var o, i, a, u, c, s, l = Ys(n), f = r, d = []; f && (c = l, s = f, o = t === Lc.Forwards ? c.next(s) : c.prev(s));) {
            if (en.isBr(o.getNode(!1))) return t === Lc.Forwards ? {
                ...
                breakType: Uy.Br,
                breakAt: D.some(o)
            } : {positions: ob(t, d), breakType: Uy.Br, breakAt: D.some(o)};
            if (o.isVisible()) {
                if (e(f, o)) {
                    var h = (i = t, a = f, u = o, en.isBr(u.getNode(i === Lc.Forwards)) ? Uy.Br : !1 === Tc(a, u) ? Uy.Block : Uy.Wrap);
                    return {positions: ob(t, d), breakType: h, breakAt: D.some(o)}
                }
                d.push(o), f = o
            } else f = o
        }
        return {positions: ob(t, d), breakType: Uy.Eol, breakAt: D.none()}
    }
    ...
    function sb(e, t, n, r) {
        var o = e === Lc.Forwards, i = o ? nb : rb;
        if (!r.collapsed) {
            var a = Iw(r);
            if (Vw(a)) return _y(e, t, a, e === Lc.Backwards, !0)
        }
        var u = function (e) {
            return Pa(e.startContainer)
        }(r), c = Oc(e, t.getBody(), r);
        if (i(c)) return Oy(t, c.getNode(!o));
        var s = my.normalizePosition(o, n(c));
        if (!s) return u ? r : null;
        if (i(s)) return _y(e, t, s.getNode(!o), o, !0);
        var l = n(s);
    ...
    function lb(e, t, n, r) {
        ...
        if (d = Iw(r), o = Oc(e, t.getBody(), r), i = n(t.getBody(), Ny(1), o), a = j(i, Sy(1)), c = Yn.last(o.getClientRects()), (nb(o) || eb(o)) && (d = o.getNode()), (rb(o) || tb(o)) && (d = o.getNode(!0)), !c) return null;
        if (s = c.left, (u = My(a, s)) && Vw(u.node)) return l = Math.abs(s - u.left), f = Math.abs(s - u.right), _y(e, t, u.node, l < f, !0);
        if (d) {
            ...
            if (u = My(j(h, Sy(1)), s)) return By(t, u.position.toRange(), !0);
            if (u = Yn.last(j(h, Sy(0)))) return By(t, u.position.toRange(), !0)
        }
    }
    ...
    function db(t, n) {
        return function () {
            var e = function (e, t) {
                var n, r = Ys(e.getBody()), o = w(Bc, r.next), i = w(Bc, r.prev), a = t ? Lc.Forwards : Lc.Backwards,
    ...
    function Ab(e, t, n, r) {
        return "" === t ? function (e, t) {
            ...
            return Xe(o, r), Bt(o, i), Tb(e, o, t), kb(i)
        }(e, r, t, n)
    }
    ...
    function Rb(t, n) {
        var r = at.fromDom(t.getBody()), o = Ic.fromRangeStart(t.selection.getRng()), i = us(t), a = cs(t);
        return function (e, t) {
            var n = w(ve, t);
    ...
    function _b(e, t) {
        return p(function (e) {
            return Y(e, function (e) {
                return ne({shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0, action: u}, e)
            })
        }(e), function (e) {
            return function (e, t) {
    ...
    function Hb(e, t) {
        ...
        return Xw(n, r).map(function (e) {
            return function (e, t) {
                return {block: W(e), position: W(t)}
            }(e, t)
        })
    }

    function Bb(t, n, e) {
        var r = Hb(t, Ic.fromRangeStart(e)), o = r.bind(function (e) {
    ...
    function Vb(e, t, n, r) {
        if (sp(n)) return np(n), ql.firstPositionIn(n.dom());
        (function (e) {
    ...
    function Ib(e, t, n) {
        if (sp(n)) return Pt(n), sp(t) && np(t), ql.firstPositionIn(t.dom());
    ...
    function jb(e, t, n) {
        return Ub(!0, t), Ub(!1, n), Fb(t, n).fold(w(Ib, e, t, n), w(Vb, e, t, n))
    }

    function qb(e, t) {
        var n = at.fromDom(t), r = w(ve, e);
    ...
    function Wb(e) {
        ...
        return $b(t, n) ? function (e) {
            ...
            return nu(Xw(n, at.fromDom(o.startContainer)), Xw(n, at.fromDom(o.endContainer)), function (e, t) {
                return !1 === ve(e, t) && (o.deleteContents(), Jw(n, !0, e, t).each(function (e) {
                    r.setRng(e.toRange())
                }), !0)
            }).getOr(!1)
        }(t, e.selection)
    ...
    function Xb(e, t, n) {
        var r = j(zm(at.fromDom(n.container()), t), ur), o = z(r).getOr(t);
    ...
    function tC(t, n) {
        ...
        return eC(t, e).filter(en.isContentEditableFalse).fold(function () {
            return function (e, t, n) {
                var r = Dc(t ? 1 : -1, e, n), o = Ic.fromRangeStart(r), i = at.fromDom(e);
                ...
                return e.fold(function (t, n) {
                    return function (e) {
                        return t._selectionOverrides.hideFakeCaret(), lp(t, n, at.fromDom(e)), !0
                    }
                }(t, n), function (n, r) {
                    return function (e) {
    ...
    function nC(e, t) {
        ...
        return !!en.isContentEditableFalse(n) && eC(e, n.parentNode).filter(en.isContentEditableFalse).fold(function () {
            ...
            }(at.fromDom(e.getBody())), lp(e, t, at.fromDom(e.selection.getNode())), Yw(e), !0
        }, function () {
            return !0
        })
    }
    ...
    function oC(t, n) {
        return function (e) {
            return dy(n, e).map(function (e) {
                return zy.setCaretPosition(t, e), !0
            }).getOr(!1)
        }
    }

    function iC(e, t, n, r) {
        var o = e.getBody(), i = w(my.isInlineTarget, e);
        e.undoManager.ignore(function () {
            ...
            }(n, r)), e.execCommand("Delete"), yy(i, o, Ic.fromRangeStart(e.selection.getRng())).map(wy).map(oC(e, t))
        }), e.nodeChanged()
    }
    ...
    function aC(n, r, o, i) {
        var a = function (e, t) {
            var n = kc(t, e);
            return n || e
        }(n.getBody(), i.container()), u = w(my.isInlineTarget, n), c = yy(u, a, i);
            ...
            return c.isSome() && e.isSome() ? my.findRootInline(u, a, i).map(function (e) {
                return !!function (o) {
                    return nu(ql.firstPositionIn(o), ql.lastPositionIn(o), function (e, t) {
                        var n = my.normalizePosition(!0, e), r = my.normalizePosition(!1, t);
                        return ql.nextPosition(o, n).map(function (e) {
                            return e.isEqual(r)
                        }).getOr(!0)
                    }).getOr(!0)
                }(e) && (lp(n, o, at.fromDom(e)), !0)
    ...
    function cC(e, t, n, r) {
        var o = w(Gg, t), i = Y(j(r, o), function (e) {
            return e.dom()
        });
        if (0 === i.length) lp(t, e, n); else {
            var a = function (e, t) {
                var n = jg(!1), r = Xg(t, n.dom());
    ...
    function sC(n, r) {
        var e = at.fromDom(n.getBody()), t = at.fromDom(n.selection.getStart()), o = j(function (e, t) {
            var n = zm(t, e);
    ...
    function vC(t, e) {
        return mC(t, e).map(function (e) {
            return function (e, t, n) {
                return {rng: W(e), table: W(t), cells: W(n)}
            }(t, e, gC(e))
        })
    }
    ...
    function wC(e, t) {
        return U(t, np), e.selection.setCursorLocation(t[0].dom(), 0), !0
    }
    ...
    function DC(e) {
        ...
        return !e.mode.isReadOnly() && (1 < t.length || function (r, e) {
            return b(e, function (e) {
                var t = RC(As(r), e), n = Je(e, t).map(MC).getOr(0);
    ...
    function OC(e, t) {
        var n = e.dom, r = e.selection, o = e.formatter, i = Ms(e), a = /[a-z%]+$/i.exec(i)[0], u = parseInt(i, 10),
            c = As(e), s = us(e);
        e.queryCommandState("InsertUnorderedList") || e.queryCommandState("InsertOrderedList") || "" !== s || n.getParent(r.getNode(), n.isBlock) || o.apply("div"), U(px(e), function (e) {
    ...
    function QC(e, t) {
        ...
        }(e.schema, c, l) && (n = i.create("br"), a.insertNode(n), a.setStartAfter(n), a.setEndAfter(n), r = !0), n = i.create("br"), Qu(i, a, n), ZC(i, o, n), JC(i, o, n, r), e.undoManager.add()
    }
    ...
    function tw(e, t) {
        ...
        var n = at.fromTag("br");
        Me(at.fromDom(t), n), ZC(e.dom, e.selection, n.dom()), JC(e.dom, e.selection, n.dom(), !1), e.undoManager.add()
    }
    ...
    function mw(e) {
        var t = us(e), n = Ex(e.dom, e.selection.getStart());
    ...
    function Tw(n, e) {
        return D.some(e).filter(Sw).bind(function (e) {
            ...
            return function (e, t) {
                ...
                return !(!Nw(n, 0) || Ew(e, r)) && (t.data = " " + n.slice(1), !0)
            }(n, t) || kw(t) || function (e, t) {
                var n = t.data, r = Ku(t, n.length - 1);
                return !(!Nw(n, n.length - 1) || Ew(e, r)) && (t.data = n.slice(0, -1) + " ", !0)
            }(n, t) ? D.some(e) : D.none()
        })
    }
    ...
    function Rw(e) {
        var t = Ic.fromRangeStart(e.selection.getRng()), n = at.fromDom(e.getBody());
        if (e.selection.isCollapsed()) {
            var r = w(my.isInlineTarget, e), o = Ic.fromRangeStart(e.selection.getRng());
    ...
    function _w(e, t) {
        ...
        if (n) return "compositionstart" === t.type ? (t.preventDefault(), t.stopPropagation(), void Dw(e, n)) : void (Ia(n) && (Dw(e, n), e.undoManager.add()))
    }
    ...
    var Hw = w(ib, Ku.isAbove, -1), Bw = w(ib, Ku.isBelow, 1), Pw = w(ab, -1, Hw), Lw = w(ab, 1, Bw),
        Vw = en.isContentEditableFalse, Iw = Qa, Fw = w(gb, function (e) {
            return e.bottom
        }, function (e, t) {
            return e.y < t
        }), Uw = w(gb, function (e) {
            ...
            return e.y > t
        }), jw = w(bb, Hw), qw = w(bb, Bw), $w = function (e) {
            for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
            ...
            t.on("keydown", function (e) {
                !1 === e.isDefaultPrevented() && function (e, t, n) {
                    var r = de().os;
                    Ww([{keyCode: vh.RIGHT, action: db(e, !0)}, {keyCode: vh.LEFT, action: db(e, !1)}, {
                        keyCode: vh.UP,
                        action: hb(e, !1)
                    }, {keyCode: vh.DOWN, action: hb(e, !0)}, {keyCode: vh.RIGHT, action: Eb(e, !0)}, {
                        keyCode: vh.LEFT,
                        action: Eb(e, !1)
                    }, {keyCode: vh.UP, action: Nb(e, !1)}, {keyCode: vh.DOWN, action: Nb(e, !0)}, {
                        keyCode: vh.RIGHT,
                        action: zy.move(e, t, !0)
                    }, {keyCode: vh.LEFT, action: zy.move(e, t, !1)}, {
                        keyCode: vh.RIGHT,
                        ctrlKey: !r.isOSX(),
                        altKey: r.isOSX(),
                    ...
                    }, {keyCode: vh.UP, action: Db(e, !1)}, {keyCode: vh.DOWN, action: Db(e, !0)}], n).each(function (e) {
                        n.preventDefault()
                    })
                }(t, n, e)
            })
            ...
            return nu(ql.firstPositionIn(u), ql.lastPositionIn(u), function (e, t) {
                var n = my.normalizePosition(!0, e), r = my.normalizePosition(!1, t), o = my.normalizePosition(!1, a);
            ...
            var r = at.fromDom(t.getBody()), e = Zw(r.dom(), n, t.selection.getRng()).bind(function (e) {
        ...
        rx = yd([{remove: ["element"]}, {moveToElement: ["element"]}, {moveToPosition: ["position"]}]),
        ox = function (e, t) {
            for (; t && t !== e;) {
            ...
            return function (e, t) {
                ...
                var r = t ? Lc.Forwards : Lc.Backwards, o = Ys(e.getBody()), i = w(Bc, o.next), a = w(Bc, o.prev),
                    u = t ? i : a, c = t ? nb : rb, s = Oc(r, e.getBody(), n), l = my.normalizePosition(t, u(s));
                if (!l || !Pc(s, l)) return !1;
                if (c(l)) return rC(e, n, s.getNode(), r, t, l);
                var f = u(l);
        ...
        }, lx = yd([{removeTable: ["element"]}, {emptyCells: ["cells"]}]), fx = function (e, t) {
            ...
            return np(t), e.selection.setCursorLocation(t.dom(), 0), D.some(!0)
        }, mx = function (e, t) {
            var n = at.fromDom(e.selection.getStart(!0)), r = Bm(e);
            return e.selection.isCollapsed() && 0 === r.length ? AC(e, t, n) : function (e, t) {
                var n = at.fromDom(e.getBody()), r = e.selection.getRng(), o = Bm(e);
        ...
        }, vx = w(LC, !1), yx = w(LC, !0), bx = w(PC, !1), Cx = w(PC, !0), wx = function (e, t, n) {
            if (e.selection.isCollapsed() && DC(e)) {
                var r = e.dom, o = e.selection.getRng(), i = Ic.fromRangeStart(o),
                    a = r.getParent(o.startContainer, r.isBlock);
                if (null !== a && vx(at.fromDom(a), i)) return OC(e, "outdent"), !0
            }
            return !1
        }, xx = function (t, n) {
            t.on("keydown", function (e) {
                !1 === e.isDefaultPrevented() && function (e, t, n) {
                    Ww([{keyCode: vh.BACKSPACE, action: $w(wx, e, !1)}, {
                        keyCode: vh.BACKSPACE,
                        action: $w(ix, e, !1)
                    }, {keyCode: vh.DELETE, action: $w(ix, e, !0)}, {
                        keyCode: vh.BACKSPACE,
                        action: $w(ux, e, !1)
                    }, {keyCode: vh.DELETE, action: $w(ux, e, !0)}, {
                        keyCode: vh.BACKSPACE,
                        action: $w(cx, e, t, !1)
                    }, {keyCode: vh.DELETE, action: $w(cx, e, t, !0)}, {
                        keyCode: vh.BACKSPACE,
                        action: $w(mx, e, !1)
                    }, {keyCode: vh.DELETE, action: $w(mx, e, !0)}, {
                        keyCode: vh.BACKSPACE,
                        action: $w(gx, e, !1)
                    }, {keyCode: vh.DELETE, action: $w(gx, e, !0)}, {
                        keyCode: vh.BACKSPACE,
                        action: $w(ex, e, !1)
                    }, {keyCode: vh.DELETE, action: $w(ex, e, !0)}, {
                        keyCode: vh.BACKSPACE,
                        action: $w(Qw, e, !1)
                    }, {keyCode: vh.DELETE, action: $w(Qw, e, !0)}, {
                        keyCode: vh.BACKSPACE,
                        action: $w(sx, e, !1)
                    }, {keyCode: vh.DELETE, action: $w(sx, e, !0)}], n).each(function (e) {
                        n.preventDefault()
                    })
                }(t, n, e)
            }), t.on("keyup", function (e) {
                !1 === e.isDefaultPrevented() && function (e, t) {
                    Ww([{keyCode: vh.BACKSPACE, action: $w(ax, e)}, {keyCode: vh.DELETE, action: $w(ax, e)}], t)
                }(t, e)
            })
        }, zx = function (e, t) {
            ...
            function n(e) {
                ...
                if ($C(c, "TABLE") || $C(c, "HR")) return v && !e || !v && e;
                var o = new Ui(c, s);
            ...
            function r() {
                f = /^(H[1-6]|PRE|FIGURE)$/.test(m) && "HGROUP" !== g ? t(p) : t(), ds(a) && WC(y, h) && y.isEmpty(s) ? f = y.split(h, s) : y.insertAfter(f, s), zx(a, f)
            }
            ...
            var x = !(!e || !e.ctrlKey);
            en.isElement(c) && c.hasChildNodes() && (v = i > c.childNodes.length - 1, c = c.childNodes[Math.min(i, c.childNodes.length - 1)] || c, i = v && en.isText(c) ? c.nodeValue.length : 0), (u = XC(y, c)) && ((p && !l || !p && l) && (c = function (e, t, n, r, o) {
                ...
                if (!(a = d.getParent(r, d.isBlock)) || !WC(d, a)) {
                    ...
                    }(a) ? a.nodeName.toLowerCase() : a.parentNode.nodeName.toLowerCase(), !a.hasChildNodes()) return i = d.create(f), GC(e, i), a.appendChild(i), n.setStart(i, 0), n.setEnd(i, 0), i;
                    for (c = r; c.parentNode !== a;) c = c.parentNode;
                    for (; c && !d.isBlock(c);) c = (u = c).previousSibling;
                    if (u && e.schema.isValidChild(l, f.toLowerCase())) {
                        for (i = d.create(f), GC(e, i), u.parentNode.insertBefore(i, u), c = u; c && !d.isBlock(c);) s = c.nextSibling, i.appendChild(c), c = s;
                        n.setStart(r, o), n.setEnd(r, o)
                    }
                }
                return r
            }(a, p, w, c, i)), s = y.getParent(c, y.isBlock), h = s ? y.getParent(s.parentNode, y.isBlock) : null, m = s ? s.nodeName.toUpperCase() : "", "LI" !== (g = h ? h.nodeName.toUpperCase() : "") || x || (h = (s = h).parentNode, m = g), /^(LI|DT|DD)$/.test(m) && y.isEmpty(s) ? Tx(a, t, h, s, p) : p && s === a.getBody() || (p = p || "P", Pa(s) ? (f = qa(s), y.isEmpty(s) && qC(s), GC(a, f), zx(a, f)) : n() ? r() : n(!0) ? (f = s.parentNode.insertBefore(t(), s), zx(a, $C(s, "HR") ? f : s)) : ((o = function (e) {
                var t = e.cloneRange();
            ...
            }(y, s), y.isEmpty(s) && qC(s), f.normalize(), y.isEmpty(f) ? (y.remove(f), r()) : (GC(a, f), zx(a, f))), y.setAttrib(f, "id", ""), a.fire("NewBlock", {newBlock: f})))
        }, Mx = function (e, t) {
            return !!function (e) {
            ...
            var n = function (e) {
                var t = w(my.isInlineTarget, e), n = Ic.fromRangeStart(e.selection.getRng());
            ...
            return iw(e, ls(e))
        }, Ox = yd([{br: []}, {block: []}, {none: []}]), Hx = function (e, t) {
            ...
            t.on("keydown", function (e) {
                e.keyCode === vh.ENTER && function (e, t) {
                    t.isDefaultPrevented() || (t.preventDefault(), function (e) {
                        ...
                        !1 === e.selection.isCollapsed() && e.execCommand("Delete"), Bx(e, t)
                    }))
                }(t, e)
            })
        }, Lx = w(pw, $r), Vx = w(pw, " "), Ix = function (t) {
            t.on("keydown", function (e) {
                !1 === e.isDefaultPrevented() && function (e, t) {
                    Ww([{keyCode: vh.SPACEBAR, action: $w(Rw, e)}], t).each(function (e) {
                        t.preventDefault()
                    })
                }(t, e)
            })
        ...
        }, Ux = de().browser, jx = function (t) {
            t.on("keydown", function (e) {
                !1 === e.isDefaultPrevented() && function (e, t) {
                    Ww([{keyCode: vh.END, action: mb(e, !0)}, {keyCode: vh.HOME, action: mb(e, !1)}], t).each(function (e) {
                        t.preventDefault()
                    })
                }(t, e)
            })
            ...
            Fx(e), Kw(e, t), xx(e, t), Px(e), Ix(e), Ow(e), jx(e)
    ...
    function Wx(r) {
        ...
        "onselectionchange" in r.getDoc() || r.on("NodeChange click mouseup keyup focus", function (e) {
            ...
            }, "nodechange" !== e.type && Vm(n, o) || r.fire("SelectionChange"), o = n
        }), r.on("contextmenu", function () {
            r.fire("SelectionChange")
        }), r.on("SelectionChange", function () {
            var e = r.selection.getStart(!0);
            !e || !Kn.range && r.selection.isCollapsed() || Fh(r) && !t.isSameElementPath(e) && r.dom.isChildOf(e, r.getBody()) && r.nodeChanged({selectionChange: !0})
    ...
    function Yx(t) {
        t.on("click", function (e) {
            3 <= e.detail && function (e) {
                var t = e.selection.getRng(), n = Ku.fromRangeStart(t), r = Ku.fromRangeEnd(t);
        ...
        return function (e) {
            if (r.dragging && function (e, t, n) {
                ...
                n.isDefaultPrevented() || (t = n.targetClone, o.undoManager.transact(function () {
                    Zx(r.element), o.insertContent(o.dom.getOuterHTML(t)), o._selectionOverrides.hideFakeCaret()
                }))
            }
            Dz(r)
        }
    ...
    function ez(e) {
        var t, n, r, o, i, a, u = {};
        t = ea.DOM, a = q.document, n = Jx(u, e), r = function (r, o) {
        ...
        }(u, e), o = Qx(u, e), i = function (e, t) {
            return function () {
                e.dragging && t.fire("dragend"), Dz(e)
            }
    ...
    function nz(g) {
        ...
        var v, y = g.getBody(), o = Cc(g, y, function (e) {
            ...
            if (i = e.startContainer, a = e.startOffset, u = e.endOffset, 3 === i.nodeType && 0 === a && Bz(i.parentNode) && (i = i.parentNode, a = h.nodeIndex(i), i = i.parentNode), 1 !== i.nodeType) return null;
            if (u === a + 1 && i === e.endContainer && (n = i.childNodes[a]), !Bz(n)) return null;
        ...
        return Kn.ceFalse && function () {
            g.on("mouseup", function (e) {
                ...
                var t;
                (t = tz(g, e.target)) && (Bz(t) && (e.preventDefault(), g.focus()), Hz(t) && g.dom.isChildOf(t, g.selection.getNode()) && s())
            ...
            (n = g).on("tap", function (e) {
                var t = tz(n, e.target);
                Bz(t) && (e.preventDefault(), c(Oy(n, t)))
            }, !0), g.on("mousedown", function (e) {
                var t, n = e.target;
                if ((n === y || "HTML" === n.nodeName || g.dom.isChildOf(n, y)) && !1 !== eh(g, e.clientX, e.clientY)) if (t = tz(g, n)) Bz(t) ? (e.preventDefault(), c(Oy(g, t))) : (s(), Hz(t) && e.shiftKey || ph(e.clientX, e.clientY, g.selection.getRng()) || (w(), g.selection.placeCaretAt(e.clientX, e.clientY))); else if (!1 === xc(n)) {
                    s(), w();
                ...
                vh.modifierPressed(e) || (e.keyCode, Bz(g.selection.getNode()) && e.preventDefault())
    ...
    function rz(a) {
        ...
        var o = Jn.each, i = vh.BACKSPACE, c = vh.DELETE, s = a.dom, l = a.selection, f = a.settings, d = a.parser,
            h = Kn.gecko, m = Kn.ie, g = Kn.webkit, p = "data:text/mce-internal,", v = m ? "Text" : "URL";
        ...
        return a.on("keydown", function (e) {
            var t, n, r, o, i;
            if (!u(e) && e.keyCode === vh.BACKSPACE && (n = (t = l.getRng()).startContainer, r = t.startOffset, o = s.getRoot(), i = n, t.collapsed && 0 === r)) {
            ...
            !vh.metaKeyPressed(e) || e.shiftKey || 37 !== e.keyCode && 39 !== e.keyCode || (e.preventDefault(), a.selection.getSel().modify("move", 37 === e.keyCode ? "backward" : "forward", "lineboundary"))
        }), n()), {
    ...
    function iz(e, t) {
        ...
        }(e), Vz.add(t.iframeContainer, r), o
    }
    ...
    function cz(e) {
        ...
        return e.inline ? uz(null) : function (e) {
            var t = Fz.create("div");
            return Fz.insertAfter(t, e), uz(t)
        }(t)
    }
        ...
        (function (e) {
            ...
            return function (t) {
                return D.from(gs(t)).filter(function (e) {
                    ...
                    return {url: t.editorManager.baseURL + "/icons/" + e + "/icons.js", name: D.some(e)}
                })
            }(n)
        }).each(function (e) {
        ...
        !function (e, t, n, r) {
            ...
            !function (e, t) {
                ...
                O(n.plugins) && (n.plugins = n.plugins.join(" ")), Jn.each(n.external_plugins, function (e, t) {
                    ...
                    if ((e = Jn.trim(e)) && !rh.urls[e]) if (sz(e)) {
    ...
    function Cz(e, t, n) {
        ...
        if (/^ | $/.test(t) && (t = function (e, t) {
        ...
        }(m.getRng(), t)), r = e.parser, h = n.merge, o = Ef({validate: e.settings.validate}, e.schema), d = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', c = {
            content: t,
            format: "html",
            selection: !0,
            paste: n.paste
            ...
            }(e, v.firstChild) && g.isEmpty(v.firstChild) && ((l = g.createRng()).setStart(v.firstChild, 0), l.setEnd(v.firstChild, 0), m.setRng(l)), m.isCollapsed() || (e.selection.setRng(Ip(e.selection.getRng())), e.getDoc().execCommand("Delete", !1, null), t = function (e, t) {
                var n, r;
            ...
            if (u = r.parse(t, y), !0 === n.paste && Wz(e.schema, u) && Xz(g, i)) return l = Kz(o, g, e.selection.getRng(), u), e.selection.setRng(l), void e.fire("SetContent", c);
            if (function (e) {
            ...
            if (e._selectionOverrides.showBlockCaretContainer(i), y.invalid) {
                for (bz(e, d), i = m.getNode(), a = e.getBody(), 9 === i.nodeType ? i = f = a : f = i; f !== a;) f = (i = f).parentNode;
            ...
            !function (e, t) {
                ...
                if (e) {
                    ...
                    r = u.getParent(e, u.isBlock), u.remove(e), r && u.isEmpty(r) && (n.$(r).empty(), s.setStart(r, 0), s.setEnd(r, 0), Yz(r) || function (e) {
    ...
    var Az = function (e, t) {
        return function (e, t, n) {
            ...
            return e.inline ? Gx(e.getBody()) : {left: 0, top: 0}
        }(e), function (e) {
            var t = e.getBody();
            ...
            var n = Gx(e.getContentAreaContainer()), r = function (e) {
    ...
    }, Mz = en.isContentEditableFalse, Rz = en.isContentEditableTrue, Dz = function (e) {
        e.dragging = !1, e.element = null, Zx(e.ghost)
    }, _z = function (e) {
        ez(e), function (n) {
    ...
    }, Hz = en.isContentEditableTrue, Bz = en.isContentEditableFalse, Pz = ea.DOM, Lz = function (t, e) {
        ...
        o.inline || (t.getElement().style.visibility = t.orgVisibility), e || t.inline || (a.open(), a.write(t.iframeHTML), a.close()), t.inline && (t.on("remove", function () {
            var e = this.getBody();
            Pz.removeClass(e, "mce-content-body"), Pz.removeClass(e, "mce-edit-focus"), Pz.setAttrib(e, "contentEditable", null)
        }), Pz.addClass(i, "mce-content-body"), t.contentDocument = a = q.document, t.contentWindow = q.window, t.bodyElement = i, t.contentAreaContainer = i, o.root_name = i.nodeName.toLowerCase()), (n = t.getBody()).disabled = !0, t.readonly = !!o.readonly, t.readonly || (t.inline && "static" === Pz.getStyle(n, "position", !0) && (n.style.position = "relative"), n.contentEditable = t.getParam("content_editable_state", !0)), n.disabled = !1, t.editorUpload = vg(t), t.schema = Lr(o), t.dom = ea(a, {
            keep_values: !0,
            ...
            return e.addAttributeFilter("src,href,style,tabindex", function (e, t) {
                ...
                for (var t, n = e.length, r = u.schema.getNonEmptyElements(); n--;) (t = e[n]).isEmpty(r) && 0 === t.getAll("br").length && (t.append(new pf("br", 1)).shortEnded = !0)
            }), e
        }(t), t.serializer = Qm(o, t), t.selection = qm(t.dom, t.getWin(), t.serializer, t), t.annotator = sf(t), t.formatter = Gp(t), t.undoManager = av(t), t._nodeChangeDispatcher = new $x(t), t._selectionOverrides = nz(t), uy(t), Kx(t), Yx(t), qx(t), cy(t), sv(t), function (e) {
            e.fire("PreInit")
        }(t), o.browser_spellcheck || o.gecko_spellcheck || (a.body.spellcheck = !1, Pz.setAttrib(n, "spellcheck", "false")), t.quirks = rz(t), function (e) {
            e.fire("PostRender")
        }(t);
        var u = Ds(t);
    ...
    }, Vz = ea.DOM, Iz = function (e, t) {
        var n = iz(e, t);
        t.editorContainer && (Vz.get(t.editorContainer).style.display = e.orgDisplay, e.hidden = Vz.isHidden(t.editorContainer)), e.getElement().style.display = "none", Vz.setAttrib(e.id, "aria-hidden", "true"), n || Lz(e)
    }, Fz = ea.DOM, Uz = function (t, n, e) {
        var r = rh.get(e), o = rh.urls[e] || t.documentBaseUrl.replace(/\/$/, "");
        ...
        e.fire("ScriptsLoaded"), function (n) {
            var e = Jn.trim(n.settings.icons), r = n.ui.registry.getAll().icons, t = ne(ne({}, {
            ...
            if (X(t)) {
                ...
                var n = oh.get(t);
                e.theme = new n(e, oh.urls[t]), e.theme.init && e.theme.init(e, oh.urls[t] || e.documentBaseUrl.replace(/\/$/, ""), e.$)
            } else e.theme = {}
        }(e), function (t) {
            var n = [];
        ...
        var t = function (e) {
            var t = e.getElement();
            return e.orgDisplay = t.style.display, X(e.settings.theme) ? function (e) {
        ...
        return e.editorContainer = t.editorContainer ? t.editorContainer : null, lh(e), e.inline ? Lz(e) : Iz(e, t)
    }, qz = ea.DOM, $z = function (t) {
        var e = t.settings, n = t.id;
        la.setCode(ks(t));
        var r = function () {
            qz.unbind(q.window, "ready", r), t.render()
        };
        if (Zr.Event.domLoaded) {
            if (t.getElement() && Kn.contentEditable) {
                ...
                o && (t.formElement = o, e.hidden_input && !en.isTextareaOrInput(t.getElement()) && (qz.insertAfter(qz.create("input", {
                    type: "hidden",
                    name: n
                }), n), t.hasHiddenInput = !0), t.formEventDelegate = function (e) {
                    t.fire(e.type, e)
                }, qz.bind(o, "submit reset", t.formEventDelegate), t.on("reset", function () {
                    t.resetContent()
                ...
                })), t.windowManager = ih(t), t.notificationManager = nh(t), "xml" === e.encoding && t.on("GetContent", function (e) {
                ...
                }, t.editorManager.on("BeforeUnload", t._beforeUnload)), t.editorManager.add(t), fz(t, t.suffix)
            }
        } else qz.bind(q.window, "ready", r)
    }, Wz = function (e, t) {
        ...
        function n(e) {
            var t = Ic.fromRangeStart(i), n = Ys(o.getRoot()), r = 1 === e ? n.prev(t) : n.next(t);
        ...
        }(o, e, t), a = pz(o, i.startContainer), u = gz(hz(r.firstChild)), c = o.getRoot();
        return n(1) ? yz(a, u, c) : n(2) ? function (e, t, n, r) {
            return r.insertAfter(t.reverse(), e), vz(t[0], n)
            ...
            return i.insertBefore(o[0], t), Jn.each(e, function (e) {
                i.insertBefore(e, t)
            }), i.insertBefore(o[1], t), i.removeChild(t), vz(e[e.length - 1], n)
        }(a, u, c, i)
    }, Xz = function (e, t) {
        return !!pz(e, t)
    }, Yz = en.matchNodeNames(["td", "th"]), Gz = function (e, t) {
        var n = function (e) {
            var t;
        ...
        wx(e, !1) || ix(e, !1) || ux(e, !1) || cx(e, !1) || Qw(e, !1) || mx(e) || ex(e, !1) || sx(e, !1) || (wz(e, "Delete"), Yw(e))
    }, Jz = function (e) {
        ix(e, !0) || ux(e, !0) || cx(e, !0) || Qw(e, !0) || mx(e) || ex(e, !0) || sx(e, !0) || wz(e, "ForwardDelete")
    }, Qz = {"font-size": "size", "font-family": "face"}, eE = {
        getFontSize: Ez("font-size"), getFontFamily: $(function (e) {
            return e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")
        }, Ez("font-family")), toPt: function (e, t) {
            return /[0-9.]+px$/.test(e) ? function (e, t) {
                var n = Math.pow(10, t);
                return Math.round(e * n) / n
            }(72 * parseInt(e, 10) / 96, t || 0) + "pt" : e
        }
    }, tE = Jn.each, nE = Jn.map, rE = Jn.inArray, oE = (iE.prototype.execCommand = function (t, n, r, e) {
        var o, i, a = !1, u = this;
        if (!u.editor.removed) {
            if (/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(t) || e && e.skip_focus ? kd(u.editor) : u.editor.focus(), (e = u.editor.fire("BeforeExecCommand", {
                command: t,
                ui: n,
                value: r
        ...
        this.addCommands({
            "mceResetDesignMode,mceBeginUndoLevel": function () {
                ...
                var t = e.substring(7);
                "full" === t && (t = "justify"), tE("left,center,right,justify".split(","), function (e) {
                ...
                !function (e, t) {
                    e.formatter.toggle("fontsize", {value: kz(e, t)}), e.nodeChanged()
                }(i, n)
    ...
    function hE(e, t) {
        var n = at.fromDom(e.getBody());
        lE(n, "mce-content-readonly", t), t ? (e.selection.controlSelection.hideResizeRect(), e._selectionOverrides.hideFakeCaret(), function (e) {
            D.from(e.selection.getNode()).each(function (e) {
                e.removeAttribute("data-mce-selected")
            })
        }(e), e.readonly = !0, dE(n, !1), function (e) {
            U(wa(e, '*[contenteditable="true"]'), function (e) {
                tn(e, zE, "true"), dE(e, !1)
            })
        }(n)) : (e.readonly = !1, dE(n, !0), function (e) {
            U(wa(e, "*[" + zE + '="true"]'), function (e) {
                Ge(e, zE), dE(e, !0)
            })
        }(n), fE(e, "StyleWithCSS", !1), fE(e, "enableInlineTableEditing", !1), fE(e, "enableObjectResizing", !1), Ld(e) && e.focus(), function (e) {
            e.selection.setRng(e.selection.getRng())
        }(e), e.nodeChanged())
    }
    ...
    function gE(t) {
        t.parser.addAttributeFilter("contenteditable", function (e) {
            mE(t) && U(e, function (e) {
                e.attr(zE, e.attr("contenteditable")), e.attr("contenteditable", "false")
            })
    ...
    function pE(e, t) {
        return "selectionchange" === t ? e.getDoc() : !e.inline && /^mouse|touch|click|contextmenu|drop|dragover|dragend/.test(t) ? e.getDoc().documentElement : e.settings.event_root ? (e.eventRoot || (e.eventRoot = EE.select(e.settings.event_root)[0]), e.eventRoot) : e.getBody()
    }
    ...
    function yE(i, a) {
        var e, t;
        if (i.delegates || (i.delegates = {}), !i.delegates[a] && !i.removed) if (e = pE(i, a), i.settings.event_root) {
            if (wE || (wE = {}, i.editorManager.on("removeEditor", function () {
                var e;
                if (!i.editorManager.activeEditor && wE) {
                    for (e in wE) i.dom.unbind(pE(i, e));
                    wE = null
                }
            })), wE[a]) return;
            t = function (e) {
            ...
            }, wE[a] = t, EE.bind(e, a, t)
        } else t = function (e) {
            vE(i, a, e)
        }, EE.bind(e, a, t), i.delegates[a] = t
    }
    ...
    function bE(e, t, n, r) {
        ...
        o.deactivate(), o.editorReadOnly !== i.editorReadOnly && hE(e, i.editorReadOnly), t.set(r), function (e, t) {
        ...
        return function (e) {
            ...
            isReadOnly: function () {
                ...
                r.set(function (e, t, n) {
                    var r;
                    if (d(SE, t)) throw new Error("Cannot override default mode " + t);
    ...
    var wE, xE = {
        ...
        bindPendingEventDelegates: function () {
            ...
            var n = this;
            "focus" !== e && "blur" !== e && (t ? n.initialized ? yE(n, e) : n._pendingNativeEvents ? n._pendingNativeEvents.push(e) : n._pendingNativeEvents = [e] : n.initialized && (n.dom.unbind(pE(n, e), e, n.delegates[e]), delete n.delegates[e]))
        }, unbindAllNativeEvents: function () {
            var e, t = this, n = t.getBody(), r = t.dom;
            if (t.delegates) {
                for (e in t.delegates) t.dom.unbind(pE(t, e), e, t.delegates[e]);
                delete t.delegates
            }
        ...
        for (n in kE(TE(e.toLowerCase(), "+"), function (e) {
            e in ME ? r[e] = !0 : /^[0-9]{2,}$/.test(e) ? r.keyCode = parseInt(e, 10) : (r.charCode = e.charCodeAt(0), r.keyCode = AE[e] || e.toUpperCase().charCodeAt(0))
        }), t = [r.keyCode], ME) r[n] ? t.push(n) : r[n] = !1;
        ...
        return (o = Jn.map(TE(e, ">"), this.parseShortcut))[o.length - 1] = Jn.extend(o[o.length - 1], {
            func: n,
            scope: r || this.editor
        }), Jn.extend(o[0], {desc: this.editor.translate(t), subpatterns: o.slice(1)})
    ...
    var OE = Jn.each, HE = Jn.trim,
        ...
        PE = {ftp: 21, http: 80, https: 443, mailto: 25}, LE = (VE.parseDataUri = function (e) {
            ...
            return 0 !== (o = (n = u.length - i) <= 0 ? v(a).join("/") : u.slice(0, n).join("/") + "/" + v(a).join("/")).indexOf("/") && (o = "/" + o), r && o.lastIndexOf("/") !== o.length - 1 && (o += r), o
    ...
    var IE = ea.DOM, FE = Jn.extend, UE = Jn.each, jE = Jn.resolve, qE = Kn.ie,
        $E = (WE.prototype.render = function () {
            ...
            if (o) return this.callbackLookup && (r = this.callbackLookup[e]) && (o = r.func, r = r.scope), "string" == typeof o && (r = (r = o.replace(/\.\w+$/, "")) ? jE(r) : 0, o = jE(o), this.callbackLookup = this.callbackLookup || {}, this.callbackLookup[e] = {
                func: o,
                scope: r
            ...
            this.hidden && (this.hidden = !1, this.inline ? this.getBody().contentEditable = "true" : (IE.show(this.getContainer()), IE.hide(this.id)), this.load(), this.fire("show"))
        }, WE.prototype.hide = function () {
            var e = this, t = e.getDoc();
            e.hidden || (qE && t && !e.inline && t.execCommand("SelectAll"), e.save(), e.inline ? (e.getBody().contentEditable = "false", e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (IE.hide(e.getContainer()), IE.setStyle(e.id, "display", e.orgDisplay)), e.hidden = !0, e.fire("hide"))
            ...
            if (o && r.initialized && !r.removed) return (e = e || {}).save = !0, e.element = o, e.content = r.getContent(e), e.no_events || r.fire("SaveContent", e), "raw" === e.format && r.fire("RawSaveContent", e), t = e.content, en.isTextareaOrInput(o) ? o.value = t : (!e.is_removing && r.inline || (o.innerHTML = t), (n = IE.getParent(r.id, "form")) && UE(n.elements, function (e) {
            ...
            return function (t, n) {
                return void 0 === n && (n = {}), D.from(t.getBody()).fold(W("tree" === n.format ? new pf("body", 11) : ""), function (e) {
                    return xf(t, n, e)
                })
            }(this, e)
            ...
            e === undefined ? Zf(this, this.startContent, {format: "raw"}) : Zf(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged()
            ...
            return this.container || (this.container = IE.get(this.editorContainer || this.id + "_parent")), this.container
        }, WE.prototype.getContentAreaContainer = function () {
            return this.contentAreaContainer
        }, WE.prototype.getElement = function () {
            return this.targetElm || (this.targetElm = IE.get(this.id)), this.targetElm
            ...
            e = e || r.getBody(), r.hasVisual === undefined && (r.hasVisual = o.visual), UE(i.select("table,a", e), function (e) {
                var t;
                switch (e.nodeName) {
                    case"TABLE":
    ...
    function XE(e) {
        e !== rN && (e ? Fi(window).on("resize scroll", KE) : Fi(window).off("resize scroll", KE), rN = e)
    }

    function YE(t) {
        var e = iN;
        delete oN[t.id];
        for (var n = 0; n < oN.length; n++) if (oN[n] === t) {
            oN.splice(n, 1);
            break
        }
        return iN = j(iN, function (e) {
            return t !== e
        }), uN.activeEditor === t && (uN.activeEditor = 0 < iN.length ? iN[0] : null), uN.focusedEditor === t && (uN.focusedEditor = null), e.length !== iN.length
    }

    var GE, ZE, JE = ea.DOM, QE = Jn.explode, eN = Jn.each, tN = Jn.extend, nN = 0, rN = !1, oN = [], iN = [],
        aN = "CSS1Compat" !== q.document.compatMode, uN = ne(ne({}, xE), {
            baseURI: null,
            baseURL: null,
            defaultSettings: {},
            ...
            setup: function () {
                var e, t, n = "";
                t = LE.getDocumentBaseUrl(q.document.location), /^[^:]+:\/\/\/?[^\/]+\//.test(t) && (t = t.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(t) || (t += "/"));
                ...
                if (r) e = r.base || r.baseURL, n = r.suffix; else {
                    ...
                    if (!e && q.document.currentScript) -1 !== (a = q.document.currentScript.src).indexOf(".min") && (n = ".min"), e = a.substring(0, a.lastIndexOf("/"))
                }
                this.baseURL = new LE(t).toAbsolute(e), this.documentBaseURL = t, this.baseURI = new LE(this.baseURL), this.suffix = n, Dd(this)
            },
            ...
            init: function (r) {
                ...
                function s(e) {
                    var t = e.id;
                    return t || (t = (t = e.name) && !JE.get(t) ? e.name : JE.uniqueId(), e.setAttribute("id", t)), t
                }
                ...
                var f = function (e) {
                    ...
                    var o, i = 0, a = [];
                    JE.unbind(window, "ready", e), function (e) {
                        var t = r[e];
                        if (t) t.apply(c, Array.prototype.slice.call(arguments, 2))
                    }("onpageload"), o = Fi.unique(function (t) {
                        var e, n = [];
                        if (Kn.browser.isIE() && Kn.browser.version.major < 11) return dh.initError("TinyMCE does not support the browser you are using. For a list of supported browsers please see: https://www.tinymce.com/docs/get-started/system-requirements/"), [];
                        if (aN) return dh.initError("Failed to initialize the editor as the document is not in standards mode. TinyMCE requires standards mode."), [];
                        if (t.types) return eN(t.types, function (e) {
                            n = n.concat(JE.select(e.selector))
                        }), n;
                        if (t.selector) return JE.select(t.selector);
                                ...
                                0 < (e = t.elements || "").length && eN(QE(e), function (t) {
                                    ...
                                    (e = JE.get(t)) ? n.push(e) : eN(q.document.forms, function (e) {
                                        eN(e.elements, function (e) {
                                            e.name === t && (t = "mce_editor_" + nN++, JE.setAttrib(e, "id", t), n.push(e))
                                        })
                                    })
                                });
                                break;
                        ...
                        Jn.each(o, function (e) {
                            return !JE.is(e, t.selector) || (n(s(e), tN({}, r, t), e), !1)
                        })
                    }) : (Jn.each(o, function (e) {
                        !function (e) {
                            e && e.initialized && !(e.getContainer() || e.getBody()).parentNode && (YE(e), e.unbindAllNativeEvents(), e.destroy(!0), e.removed = !0, e = null)
                        }(c.get(e.id))
                ...
                return c.settings = r, JE.bind(window, "ready", e), new xn(function (t) {
                    n ? t(n) : f = function (e) {
                        t(e)
                    }
                })
            ...
            add: function (e) {
                ...
                return oN[e.id] === e || (null === n.get(e.id) && (function (e) {
                    return "length" !== e
                }(e.id) && (oN[e.id] = e), oN.push(e), iN.push(e)), XE(!0), n.activeEditor = e, n.fire("AddEditor", {editor: e}), GE || (GE = function (e) {
                    var t = n.fire("BeforeUnload");
                    if (t.returnValue) return e.preventDefault(), e.returnValue = t.returnValue, t.returnValue
                }, window.addEventListener("beforeunload", GE))), e
            },
            ...
            remove: function (e) {
                var t, n, r = this;
                if (e) {
                    if (!X(e)) return n = e, H(r.get(n.id)) ? null : (YE(n) && r.fire("RemoveEditor", {editor: n}), 0 === iN.length && window.removeEventListener("beforeunload", GE), n.remove(), XE(0 < iN.length), n);
            ...
            execCommand: function (e, t, n) {
                ...
                switch (e) {
                    case"mceAddEditor":
                        return this.get(n) || new $E(n, this.settings, this).render(), !0;
    ...
    uN.setup(), (ZE = cN = cN || {}).compareRanges = Vm, ZE.getCaretRangeFromPoint = Cm, ZE.getSelectedNode = Qa, ZE.getNode = eu;

    function sN(e, t, n) {
        var r, o, i, a, u, c;
        return r = t.x, o = t.y, i = e.w, a = e.h, u = t.w, c = t.h, "b" === (n = (n || "").split(""))[0] && (o += c), "r" === n[1] && (r += u), "c" === n[0] && (o += bN(c / 2)), "c" === n[1] && (r += bN(u / 2)), "b" === n[3] && (o -= a), "r" === n[4] && (r -= i), "c" === n[3] && (o -= bN(a / 2)), "c" === n[4] && (r -= bN(i / 2)), CN(r, o, i, a)
    }

    function lN() {
    }

    var fN, dN, hN, mN, gN = cN, pN = (fN = {}, dN = {}, {
        load: function (r, o) {
            var i = 'Script at URL "' + o + '" failed to load',
                a = 'Script at URL "' + o + "\" did not call `tinymce.Resource.add('" + r + "', data)` within 1 second";
            if (fN[r] !== undefined) return fN[r];
            var e = new xn(function (e, t) {
                var n = function (e, t, n) {
                    function r(n) {
                        return function () {
                            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                            o || (o = !0, null !== i && (q.clearTimeout(i), i = null), n.apply(null, e))
                        }
                    }
                ...
                dN[r] = n.resolve, oa.ScriptLoader.loadScript(o, function () {
                    return n.start(a)
                }, function () {
                    return n.reject(i)
                })
            ...
            dN[e] !== undefined && (dN[e](t), delete dN[e]), fN[e] = xn.resolve(t)
        }
        ...
        }, relativePosition: sN, findBestRelativePosition: function (e, t, n, r) {
            var o, i;
            for (i = 0; i < r.length; i++) if ((o = sN(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y) return r[i];
            return null
        }, intersect: function (e, t) {
            var n, r, o, i;
            return n = yN(e.x, t.x), r = yN(e.y, t.y), o = vN(e.x + e.w, t.x + t.w), i = vN(e.y + e.h, t.y + t.h), o - n < 0 || i - r < 0 ? null : CN(n, r, o - n, i - r)
        }, clamp: function (e, t, n) {
            var r, o, i, a, u, c, s, l, f, d;
            return u = e.x, c = e.y, s = e.x + e.w, l = e.y + e.h, f = t.x + t.w, d = t.y + t.h, r = yN(0, t.x - u), o = yN(0, t.y - c), i = yN(0, s - f), a = yN(0, l - d), u += r, c += o, n && (s += r, l += o, u -= i, c -= a), CN(u, c, (s -= i) - u, (l -= a) - c)
        }, create: CN, fromClientRect: function (e) {
    ...
    lN.extend = hN = function (n) {
        function r() {
            var e, t, n;
            if (!mN && (this.init && this.init.apply(this, arguments), t = this.Mixins)) for (e = t.length; e--;) (n = t[e]).init && n.init.apply(this, arguments)
        }
        ...
        for (i in mN = !0, o = new this, mN = !1, n.Mixins && (xN(n.Mixins, function (e) {
            for (var t in e) "init" !== t && (n[t] = e[t])
        }), u.Mixins && (n.Mixins = u.Mixins.concat(n.Mixins))), n.Methods && xN(n.Methods.split(","), function (e) {
            n[e] = t
            ...
            r[t] = e
        }), n.Defaults && u.Defaults && (n.Defaults = zN({}, u.Defaults, n.Defaults)), n) "function" == typeof (a = n[i]) && u[i] ? o[i] = e(i, a) : o[i] = a;
        return r.prototype = o, (r.constructor = r).extend = hN, r
    };
    var EN = Math.min, NN = Math.max, SN = Math.round, kN = {
        serialize: function (e) {
        ...
        callbacks: {}, count: 0, send: function (t) {
            var n = this, r = ea.DOM, o = t.count !== undefined ? t.count : n.count, i = "tinymce_jsonp_" + o;
        ...
        send: function (e) {
            ...
            if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = !1 !== e.async, e.data = e.data || "", AN.fire("beforeInitialize", {settings: e}), t = new q.XMLHttpRequest) {
                ...
                }), t.setRequestHeader("X-Requested-With", "XMLHttpRequest"), (t = AN.fire("beforeSend", {
                    xhr: t,
                    settings: e
    ...
    }), MN = Jn.extend, RN = (DN.sendRPC = function (e) {
        return (new DN).send(e)
    }, DN.prototype.send = function (e) {
        var n = e.error, r = e.success, o = MN(this.settings, e);
        o.success = function (e, t) {
            void 0 === (e = kN.parse(e)) && (e = {error: "JSON Parse error."}), e.error ? n.call(o.error_scope || o.scope, e.error, t) : r.call(o.success_scope || o.scope, e.result)
            ...
            method: e.method,
            params: e.params
        }), o.content_type = "application/json", AN.send(o)
    }, DN);
            ...
            Color: function (e) {
                function t(e) {
                    ...
                    return "object" == typeof e ? "r" in e ? (u = e.r, c = e.g, s = e.b) : "v" in e && function (e, t, n) {
                        var r, o, i, a;
                        if (e = (parseInt(e, 10) || 0) % 360, t = parseInt(t, 10) / 100, n = parseInt(n, 10) / 100, t = NN(0, EN(t, 1)), n = NN(0, EN(n, 1)), 0 !== t) {
                            ...
                            u = SN(255 * (u + a)), c = SN(255 * (c + a)), s = SN(255 * (s + a))
                        } else u = c = s = SN(255 * n)
                ...
                return e && t(e), n.toRgb = function () {
                    ...
                    return function (e, t, n) {
                        var r, o, i, a;
                        return o = 0, (i = EN(e /= 255, EN(t /= 255, n /= 255))) === (a = NN(e, NN(t, n))) ? {
                            h: 0,
                            s: 0,
                            v: 100 * (o = i)
                        } : (r = (a - i) / a, {
    ...
    PN = VN, window.tinymce = PN, window.tinyMCE = PN, function (e) {
